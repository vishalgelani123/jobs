        ...
        var t = {
            36096: function (t, e, i) {
                ...
                var b = function () {
                    ...
                    return h(t, [{
                        ...
                        key: "animatePathsGradually", value: function (t) {
                            var e = t.el, i = t.realIndex, a = t.j, s = t.fill, r = t.pathFrom, o = t.pathTo,
                                n = t.speed, l = t.delay, h = this.w, c = 0;
                    ...
                    return h(t, [{
                        ...
                        key: "dropShadow", value: function (t, e) {
                            ...
                            return t.unfilter(!0), b.isIE() && "radialBar" === h.config.chart.type || (o = Array.isArray(o) ? o[i] : o, t.filter((function (t) {
                                var e;
                                e = b.isSafari() || b.isFirefox() || b.isIE() ? t.flood(o, n).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(r) : t.flood(o, n).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(r).merge(t.source), t.blend(t.source, e)
                    ...
                    return h(t, [{
                        ...
                        key: "renderPaths", value: function (t) {
                            var e, i = t.j, a = t.realIndex, s = t.pathFrom, o = t.pathTo, n = t.stroke,
                                l = t.strokeWidth, h = t.strokeLinecap, c = t.fill, d = t.animationDelay,
                                g = t.initialSpeed, u = t.dataChangeSpeed, p = t.className, f = t.shouldClipToGrid,
                                x = void 0 === f || f, b = t.bindEventsOnPaths, y = void 0 === b || b, w = t.drawShadow,
                                k = void 0 === w || w, A = this.w, S = new m(this.ctx), C = new v(this.ctx),
                            ...
                            if (z.attr("index", a), x && z.attr({"clip-path": "url(#gridRectMask".concat(A.globals.cuid, ")")}), "none" !== A.config.states.normal.filter.type) S.getDefaultFilter(z, a); else if (A.config.chart.dropShadow.enabled && k && (!A.config.chart.dropShadow.enabledOnSeries || A.config.chart.dropShadow.enabledOnSeries && -1 !== A.config.chart.dropShadow.enabledOnSeries.indexOf(a))) {
                            ...
                            return !L || A.globals.resized || A.globals.dataChanged ? !A.globals.resized && A.globals.dataChanged || C.showDelayedElements() : C.animatePathsGradually(r(r({}, E), {}, {speed: g})), A.globals.dataChanged && P && T && C.animatePathsGradually(r(r({}, E), {}, {speed: u})), z
                        }
                    }, {
                        ...
                        key: "drawText", value: function (t) {
                            var e, i = t.x, a = t.y, s = t.text, r = t.textAnchor, o = t.fontSize, n = t.fontFamily,
                                l = t.fontWeight, h = t.foreColor, c = t.opacity, d = t.cssClass,
                                g = void 0 === d ? "" : d, u = t.isPlainText, p = void 0 === u || u, f = this.w;
                    ...
                    return h(t, [{
                        ...
                        key: "_getY1Y2", value: function (t, e) {
                            ...
                            if (this.annoCtx.invertAxis) {
                                ...
                                var n;
                                n = s.config.yaxis[e.yAxisIndex].logarithmic ? (a = new A(this.annoCtx.ctx).getLogVal(a, e.yAxisIndex)) / s.globals.yLogRatio[e.yAxisIndex] : (a - s.globals.minYArr[e.yAxisIndex]) / (s.globals.yRange[e.yAxisIndex] / s.globals.gridHeight), i = s.globals.gridHeight - n, s.config.yaxis[e.yAxisIndex] && s.config.yaxis[e.yAxisIndex].reversed && (i = n)
                            }
                            return i
                        }
                    }, {
                    ...
                    return h(t, [{
                        key: "addPointAnnotation", value: function (t, e, i) {
                            ...
                            if (a.config.yaxis[t.yAxisIndex].logarithmic) h = (n = new A(this.annoCtx.ctx).getLogVal(n, t.yAxisIndex)) / a.globals.yLogRatio[t.yAxisIndex]; else {
                                var f = t.yAxisIndex + d;
                                h = (n - a.globals.minYArr[f]) / (a.globals.yRange[f] / a.globals.gridHeight)
                            }
                            if (r = a.globals.gridHeight - h - parseFloat(t.label.style.fontSize) - t.marker.size, o = a.globals.gridHeight - h, a.config.yaxis[t.yAxisIndex] && a.config.yaxis[t.yAxisIndex].reversed && (r = h + parseFloat(t.label.style.fontSize) + t.marker.size, o = h), b.isNumber(s)) {
                                var x = {
                                    pSize: t.marker.size,
                                ...
                                var m = t.label.text ? t.label.text : "", y = this.annoCtx.graphics.drawText({
                                    x: s + t.label.offsetX,
                                    y: r + t.label.offsetY,
                                    text: m,
                                    textAnchor: t.label.textAnchor,
                    ...
                    function t(e) {
                        n(this, t), this.ctx = e, this.w = e.w, this.graphics = new y(this.ctx), this.w.globals.isBarHorizontal && (this.invertAxis = !0), this.helpers = new w(this), this.xAxisAnnotations = new k(this), this.yAxisAnnotations = new S(this), this.pointsAnnotations = new C(this), this.w.globals.isBarHorizontal && this.w.config.yaxis[0].reversed && (this.inversedReversedAxis = !0), this.xDivision = this.w.globals.gridWidth / this.w.globals.dataPoints
                    }
                    ...
                    return h(t, [{
                        ...
                        key: "addText", value: function (t, e) {
                            var i = t.x, a = t.y, s = t.text, r = t.textAnchor, o = t.foreColor, n = t.fontSize,
                                ...
                                C = void 0 === S ? 2 : S, L = this.w, P = this.graphics.drawText({
                                    x: i,
                                    y: a,
                                    text: s,
                                    textAnchor: r || "start",
                    ...
                    return h(t, [{
                        ...
                        key: "fillPath", value: function (t) {
                            ...
                            t.color && (o = t.color);
                            var h = o;
                            if (-1 === o.indexOf("rgb") ? o.length < 9 && (h = b.hexToRgba(o, l)) : o.indexOf("rgba") > -1 && (l = b.getOpacityFromRGBA(o)), t.opacity && (l = t.opacity), "pattern" === n && (a = this.handlePatternFill(a, o, l, h)), "gradient" === n && (s = this.handleGradientFill(o, l, this.seriesIndex)), "image" === n) {
                        ...
                        key: "handlePatternFill", value: function (t, e, i, a) {
                            var s = this.w.config, r = this.opts, o = new y(this.ctx),
                        ...
                        key: "handleGradientFill", value: function (t, e, i) {
                            var a, s = this.w.config, r = this.opts, o = new y(this.ctx), n = new b,
                            ...
                            if (void 0 === s.fill.gradient.gradientToColors || 0 === s.fill.gradient.gradientToColors.length) a = "dark" === s.fill.gradient.shade ? n.shadeColor(-1 * parseFloat(s.fill.gradient.shadeIntensity), t.indexOf("rgb") > -1 ? b.rgb2hex(t) : t) : n.shadeColor(parseFloat(s.fill.gradient.shadeIntensity), t.indexOf("rgb") > -1 ? b.rgb2hex(t) : t); else if (s.fill.gradient.gradientToColors[r.seriesNumber]) {
                    ...
                    return h(t, [{
                        ...
                        key: "plotChartMarkers", value: function (t, e, i, a) {
                            var s, r = arguments.length > 4 && void 0 !== arguments[4] && arguments[4], o = this.w,
                                n = e, l = t, h = null, c = new y(this.ctx);
                            if ((o.globals.markers.size[e] > 0 || r) && (h = c.group({class: r ? "" : "apexcharts-series-markers"})).attr("clip-path", "url(#gridRectMarkerMask".concat(o.globals.cuid, ")")), Array.isArray(l.x)) for (var d = 0; d < l.x.length; d++) {
                                ...
                                if ("line" !== o.config.chart.type && "area" !== o.config.chart.type || o.globals.comboCharts || o.config.tooltip.intersect || (u += " no-pointer-events"), (Array.isArray(o.config.markers.size) ? o.globals.markers.size[e] > 0 : o.config.markers.size > 0) || r) {
                                    ...
                                    o.config.series[n].data[g] && (o.config.series[n].data[g].fillColor && (p.pointFillColor = o.config.series[n].data[g].fillColor), o.config.series[n].data[g].strokeColor && (p.pointStrokeColor = o.config.series[n].data[g].strokeColor)), a && (p.pSize = a), (s = c.drawMarker(l.x[d], l.y[d], p)).attr("rel", g), s.attr("j", g), s.attr("index", e), s.node.setAttribute("default-marker-size", p.pSize), new m(this.ctx).setSelectionFilter(s, e, g), this.addEvents(s), h && h.add(s)
                    ...
                    return h(t, [{
                        key: "draw", value: function (t, e, i) {
                            var a = this.w, s = new y(this.ctx), r = i.realIndex, o = i.pointsPos, n = i.zRatio,
                                l = i.elParent,
                        ...
                        key: "drawPoint", value: function (t, e, i, a, s, r, o) {
                            var n = this.w, l = s, h = new v(this.ctx), c = new m(this.ctx), d = new M(this.ctx),
                                g = new I(this.ctx), u = new y(this.ctx), p = g.getMarkerConfig({
                    ...
                    return h(t, [{
                        ...
                        key: "drawDataLabel", value: function (t, e, i) {
                            var a = this, s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 2,
                                r = this.w, o = new y(this.ctx), n = r.config.dataLabels, l = 0, h = 0, c = i, d = null;
                            ...
                            for (var g = 0; g < t.x.length; g++) if (l = t.x[g] + n.offsetX, h = t.y[g] + n.offsetY + s, !isNaN(l)) {
                                ...
                                if ("bubble" === r.config.chart.type) p = f(u = r.globals.seriesZ[e][c]), h = t.y[g], h = new z(this.ctx).centerTextInBubble(h, e, c).y; else void 0 !== u && (p = f(u));
                        ...
                        key: "plotDataLabelsText", value: function (t) {
                            var e = this.w, i = new y(this.ctx), a = t.x, s = t.y, r = t.i, o = t.j, n = t.text,
                    ...
                    return h(t, [{
                        key: "handleBarDataLabels", value: function (t) {
                            var e = t.x, i = t.y, a = t.y1, s = t.y2, r = t.i, o = t.j, n = t.realIndex, l = t.series,
                                ...
                                u = t.renderedPath, p = this.w, f = new y(this.barCtx.ctx),
                            ...
                            var m, w = e, k = i, A = p.config.dataLabels, S = this.barCtx.barOptions.dataLabels;
                            ...
                            return m = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(M) : this.calculateColumnsDataLabelsPosition(M), u.attr({
                                cy: m.bcy,
                                cx: m.bcx,
                                j: o,
                                val: l[r][o],
                        ...
                        key: "drawCalculatedDataLabels", value: function (t) {
                            var e = t.x, i = t.y, a = t.val, s = t.i, o = t.j, n = t.textRects, l = t.barHeight,
                                h = t.barWidth, c = t.dataLabelsConfig, d = this.w, g = "rotate(0)";
                            "vertical" === d.config.plotOptions.bar.dataLabels.orientation && (g = "rotate(-90, ".concat(e, ", ").concat(i, ")"));
                            var u = new X(this.barCtx.ctx), p = new y(this.barCtx.ctx), f = c.formatter, x = null,
                            ...
                            if (c.enabled && !b) {
                                ...
                                var m = d.globals.series[s][o] < 0, w = d.config.plotOptions.bar.dataLabels.position;
                                "vertical" === d.config.plotOptions.bar.dataLabels.orientation && ("top" === w && (c.textAnchor = m ? "end" : "start"), "center" === w && (c.textAnchor = "middle"), "bottom" === w && (c.textAnchor = m ? "end" : "start")), this.barCtx.isTimelineBar && this.barCtx.barOptions.dataLabels.hideOverflowingLabels && h < p.getTextRects(v, parseFloat(c.style.fontSize)).width && (v = ""), d.config.chart.stacked && this.barCtx.barOptions.dataLabels.hideOverflowingLabels && (this.barCtx.isHorizontal ? n.width / 1.6 > Math.abs(h) && (v = "") : n.height / 1.6 > Math.abs(l) && (v = ""));
                                var k = r({}, c);
                    ...
                    return h(t, [{
                        ...
                        key: "getPathFillColor", value: function (t, e, i, a) {
                            var s = this.w, r = new M(this.barCtx.ctx), o = null,
                        ...
                        key: "barBackground", value: function (t) {
                            var e = t.j, i = t.i, a = t.x1, s = t.x2, r = t.y1, o = t.y2, n = t.elSeries, l = this.w,
                                h = new y(this.barCtx.ctx), c = new Y(this.barCtx.ctx).getActiveConfigSeriesIndex();
                        ...
                        key: "getColumnPaths", value: function (t) {
                            var e = t.barWidth, i = t.barXPosition, a = t.yRatio, s = t.y1, r = t.y2, o = t.strokeWidth,
                                n = t.series, l = t.realIndex, h = t.i, c = t.j, d = t.w, g = new y(this.barCtx.ctx);
                            (o = Array.isArray(o) ? o[l] : o) && 0 !== n[h][c] || (o = 0), 0 === n[h][c] && (e = 0);
                            var u = {barWidth: e, strokeWidth: o, yRatio: a, barXPosition: i, y1: s, y2: r},
                                p = this.getRoundedBars(d, u, n, h, c), f = i, x = i + e, b = g.move(f, p.y1),
                                v = g.move(f, p.y1), m = g.line(x - o, p.y1);
                            return d.globals.previousPaths.length > 0 && (v = this.barCtx.getPreviousPath(l, c, !1)), b = b + g.line(f, p.y2) + p.startingShape + g.line(x - o, p.y2) + m + p.endingShape + "z", v = v + g.line(f, p.y1) + m + m + m + m + m + g.line(f, p.y1), d.config.chart.stacked && (this.barCtx.yArrj.push(p.y2), this.barCtx.yArrjF.push(Math.abs(s - p.y2)), this.barCtx.yArrjVal.push(this.barCtx.series[h][c])), {
                                pathTo: b,
                                pathFrom: v
                            }
                        }
                        ...
                        key: "getBarpaths", value: function (t) {
                            var e = t.barYPosition, i = t.barHeight, a = t.x1, s = t.x2, r = t.strokeWidth,
                                o = t.series, n = t.realIndex, l = t.i, h = t.j, c = t.w, d = new y(this.barCtx.ctx);
                            (r = Array.isArray(r) ? r[n] : r) && !o[l][h] || (r = 0), 0 === o[l][h] && (i = 0);
                            var g = {barHeight: i, strokeWidth: r, barYPosition: e, x2: s, x1: a},
                                u = this.getRoundedBars(c, g, o, l, h), p = d.move(u.x1, e), f = d.move(u.x1, e);
                            c.globals.previousPaths.length > 0 && (f = this.barCtx.getPreviousPath(n, h, !1));
                            var x = e, b = e + i, v = d.line(u.x1, b - r);
                            return p = p + d.line(u.x2, x) + u.startingShape + d.line(u.x2, b - r) + v + v + u.endingShape + "z", f = f + d.line(u.x1, x) + v + v + v + v + v + d.line(u.x1, x), c.config.chart.stacked && (this.barCtx.xArrj.push(u.x2), this.barCtx.xArrjF.push(Math.abs(u.x1 - u.x2)), this.barCtx.xArrjVal.push(this.barCtx.series[l][h])), {
                                pathTo: p,
                                pathFrom: f
                            }
                        }
                        ...
                        key: "getRoundedBars", value: function (t, e, i, a, s) {
                            var r = new y(this.barCtx.ctx), o = 0, n = t.config.plotOptions.bar.borderRadius;
                            if (o = Array.isArray(n) ? n[a > n.length - 1 ? n.length - 1 : a] : n, this.barCtx.isHorizontal) {
                                var l = "", h = "", c = o, d = o, g = e.x1, u = e.x2;
                        ...
                        key: "drawGoalLine", value: function (t) {
                            var e = t.barXPosition, i = t.barYPosition, a = t.goalX, s = t.goalY, r = t.barWidth,
                                o = t.barHeight, n = new y(this.barCtx.ctx),
                    ...
                    return h(t, [{
                        key: "draw", value: function (t, e) {
                            ...
                            for (var n = 0, l = 0; n < t.length; n++, l++) {
                                var h, c, d, g, u = void 0, p = void 0, f = [], x = [],
                                    v = i.globals.comboCharts ? e[n] : n, m = a.group({
                                ...
                                for (var C = a.group({
                                    ...
                                    this.isHorizontal ? (M = this.drawBarPaths(r(r({}, I), {}, {
                                        barHeight: w,
                                        zeroW: g,
                                        yDivision: c
                                    })), k = this.series[n][P] / this.invertedYRatio) : (M = this.drawColumnPaths(r(r({}, I), {}, {
                                        xDivision: h,
                                        barWidth: k,
                                        zeroH: d
                        ...
                        key: "renderSeries", value: function (t) {
                            var e = t.realIndex, i = t.pathFill, a = t.lineFill, s = t.j, r = t.i, o = t.pathFrom,
                                ...
                                p = t.series, f = t.barHeight, x = t.barWidth, b = t.barYPosition,
                                v = t.elDataLabelsWrap, w = t.elGoalsMarkers, k = t.visibleSeries, A = t.type,
                                S = this.w, C = new y(this.ctx);
                            ...
                            T.count > 0 && s >= S.globals.dataPoints - T.count && (P.node.setAttribute("stroke-dasharray", T.dashArray), P.node.setAttribute("stroke-width", T.strokeWidth), P.node.setAttribute("fill-opacity", T.fillOpacity)), void 0 !== g && void 0 !== u && (P.attr("data-range-y1", g), P.attr("data-range-y2", u)), new m(this.ctx).setSelectionFilter(P, e, s), h.add(P);
                        ...
                        key: "drawColumnPaths", value: function (t) {
                            var e = t.indexes, i = t.x, a = t.y, s = t.xDivision, r = t.barWidth, o = t.zeroH,
                                n = t.strokeWidth, l = t.elSeries, h = this.w, c = e.realIndex, d = e.i, g = e.j,
                                u = e.bc;
                    ...
                    return h(t, [{
                        ...
                        key: "formatDate", value: function (t, e) {
                            var i = this.w.globals.locale, a = this.w.config.xaxis.labels.datetimeUTC,
                                s = ["\0"].concat(f(i.months)), r = [""].concat(f(i.shortMonths)),
                                o = [""].concat(f(i.days)), n = [""].concat(f(i.shortDays));
                    ...
                    return h(i, [{
                        key: "draw", value: function (t, e) {
                            ...
                            for (var s = a.group({class: "apexcharts-rangebar-series apexcharts-plot-series"}), o = 0; o < t.length; o++) {
                                var n, l, h, c = void 0, d = void 0, g = void 0, u = i.globals.comboCharts ? e[o] : o,
                                    p = a.group({
                                        class: "apexcharts-series",
                                        seriesName: b.escapeString(i.globals.seriesNames[u]),
                                        rel: o + 1,
                                        "data:realIndex": u
                                    });
                                ...
                                for (var m = a.group({
                                    ...
                                    } else f = (L = this.drawRangeColumnPaths(r({
                                        indexes: {i: o, j: k, realIndex: u},
                                        zeroH: l,
                                        barWidth: x,
                                        xDivision: n
                                ...
                                tooltip: {
                                    shared: !1, followCursor: !0, custom: function (t) {
                                        return t.w.config.plotOptions && t.w.config.plotOptions.bar && t.w.config.plotOptions.bar.horizontal ? function (t) {
                                            var e = new D(t.ctx, null), i = e.getTooltipValues(t), a = i.color,
                    ...
                    return h(t, [{
                        ...
                        key: "isFormatXY", value: function () {
                            var t = this.w.config.series.slice(), e = new Y(this.ctx);
                        ...
                        key: "handleRangeDataFormat", value: function (t, e, i) {
                            ...
                            if ("array" === t) {
                                ...
                                for (var h = function (t) {
                                    var o = b.randomId(), n = e[i].data[t].x,
                        ...
                        key: "parseDataAxisCharts", value: function (t) {
                            var e = this, i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.ctx,
                                a = this.w.config, s = this.w.globals, r = new H(i),
                        ...
                        key: "handleExternalLabelsData", value: function (t) {
                            ...
                            }))), e.xaxis.convertedCatToNumeric && (new N(e).convertCatToNumericXaxis(e, this.ctx, i.seriesX[0]), this._generateExternalLabels(t))) : this._generateExternalLabels(t)
                        }
                    }, {
                    ...
                    return h(t, [{
                        key: "getLabel", value: function (t, e, i, a) {
                            var s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [],
                                ...
                                c = o.config.xaxis.labels.formatter, d = !1, g = n;
                            l = new G(this.ctx).xLabelFormat(h, n, g, {
                                i: a,
                                dateFormatter: new H(this.ctx).formatDate,
                                w: o
                            }), void 0 !== c && (l = c(n, t[a], {
                                i: a,
                                dateFormatter: new H(this.ctx).formatDate,
                            ...
                            e.length > 0 ? (d = function (t) {
                                var i = null;
                                return e.forEach((function (t) {
                                    "month" === t.unit ? i = "year" : "day" === t.unit ? i = "month" : "hour" === t.unit ? i = "day" : "minute" === t.unit && (i = "hour")
                                })), i === t
                            }(e[a].unit), i = e[a].position, l = e[a].value) : "datetime" === o.config.xaxis.type && void 0 === c && (l = ""), void 0 === l && (l = ""), l = Array.isArray(l) ? l : l.toString();
                            var u, p = new y(this.ctx);
                            ...
                            return !Array.isArray(l) && (0 === l.indexOf("NaN") || 0 === l.toLowerCase().indexOf("invalid") || l.toLowerCase().indexOf("infinity") >= 0 || s.indexOf(l) >= 0 && f) && (l = ""), {
                                x: i,
                                text: l,
                                textRect: u,
                                isBold: d
                    ...
                    return h(t, [{
                        ...
                        key: "exportToCSV", value: function (t) {
                            var e = this, i = t.series, a = t.columnDelimiter, s = t.lineDelimiter,
                                r = void 0 === s ? "\n" : s, o = this.w, n = [], l = [],
                                h = "data:text/csv;charset=utf-8,\ufeff", c = new V(this.ctx), d = new _(this.ctx),
                                g = function (t) {
                                    var i = "";
                    ...
                    return h(t, [{
                        key: "drawXaxis", value: function () {
                            var t, e = this, i = this.w, a = new y(this.ctx), s = a.group({
                    ...
                    return h(t, [{
                        ...
                        key: "createGridMask", value: function () {
                            ...
                            ("bar" === r || "rangeBar" === r || "candlestick" === r || "boxPlot" === r || t.globals.comboBarCount > 0) && t.globals.isXNumeric && !t.globals.isBarHorizontal && (o = t.config.grid.padding.left, n = t.config.grid.padding.right, e.barPadForNumericAxis > o && (o = e.barPadForNumericAxis, n = e.barPadForNumericAxis)), e.dom.elGridRect = i.drawRect(-a / 2 - o - 2, -a / 2, e.gridWidth + a + n + o + 4, e.gridHeight + a, 0, "#fff"), new A(this).getLargestMarkerSize();
                        ...
                        key: "_drawGridBandRect", value: function (t) {
                            var e = t.c, i = t.x1, a = t.y1, s = t.x2, r = t.y2, o = t.type, n = this.w,
                                l = new y(this.ctx), h = n.globals.barPadForNumericAxis;
                        ...
                        key: "_drawInvertedXYLines", value: function (t) {
                            ...
                            }), new U(this.ctx).drawXaxisTicks(s, this.elg), a = s = s + i.globals.gridWidth / e + .3;
                    ...
                    return h(t, [{
                        key: "niceScale", value: function (t, e) {
                            ...
                            if ("dataPoints" === (i = this._adjustTicksForSmallRange(i, a, o)) && (i = r.globals.dataPoints - 1), t === Number.MIN_VALUE && 0 === e || !b.isNumber(t) && !b.isNumber(e) || t === Number.MIN_VALUE && e === -Number.MAX_VALUE) return t = 0, e = i, this.linearScale(t, e, i);
                            ...
                            var l = i + 1;
                            l < 2 ? l = 2 : l > 2 && (l -= 2);
                            var h = o / l, c = Math.floor(b.log10(h)), d = Math.pow(10, c), g = Math.round(h / d);
                            g < 1 && (g = 1);
                        ...
                        key: "setYScaleForIndex", value: function (t, e, i) {
                            ...
                            var o = Math.abs(i - e);
                            if (r.logarithmic && o <= 5 && (a.invalidLogScale = !0), r.logarithmic && o > 5) a.allSeriesCollapsed = !1, a.yAxisScale[t] = this.logarithmicScale(i); else if (i !== -Number.MAX_VALUE && b.isNumber(i)) if (a.allSeriesCollapsed = !1, void 0 === r.min && void 0 === r.max || r.forceNiceScale) {
                    ...
                    return h(t, [{
                        ...
                        key: "getMinYMaxY", value: function (t) {
                            ...
                            for (var d = t; d < a; d++) {
                                ...
                                for (var g = 0; g < r.series[d].length; g++) {
                                    ...
                                    })), b.isFloat(u) && (u = b.noExponents(u), r.yValueDecimal = Math.max(r.yValueDecimal, u.toString().split(".")[1].length)), n > h[d][g] && h[d][g] < 0 && (n = h[d][g])) : r.hasNullValues = !0
                                }
                            }
                        ...
                        key: "_setStackedMinMax", value: function () {
                            ...
                            if (t.series.length) for (var a = 0; a < t.series[t.maxValsInArrayIndex].length; a++) for (var s = 0, r = 0, o = 0; o < t.series.length; o++) null !== t.series[o][a] && b.isNumber(t.series[o][a]) && (t.series[o][a] > 0 ? s = s + parseFloat(t.series[o][a]) + 1e-4 : r += parseFloat(t.series[o][a])), o === t.series.length - 1 && (e.push(s), i.push(r));
                    ...
                    return h(t, [{
                        key: "drawYaxis", value: function (t) {
                            var e = this, i = this.w, a = new y(this.ctx), s = i.config.yaxis[t].labels.style,
                    ...
                    return h(t, [{
                        key: "drawAxis", value: function (t, e) {
                            var i, a, s = this.w.globals, r = this.w.config, o = new U(this.ctx), n = new J(this.ctx);
                    ...
                    return h(t, [{
                        key: "drawXCrosshairs", value: function () {
                            var t = this.w, e = new y(this.ctx), i = new m(this.ctx),
                                a = t.config.xaxis.crosshairs.fill.gradient, s = t.config.xaxis.crosshairs.dropShadow,
                                r = t.config.xaxis.crosshairs.fill.type, o = a.colorFrom, n = a.colorTo,
                                l = a.opacityFrom, h = a.opacityTo, c = a.stops, d = s.enabled, g = s.left, u = s.top,
                                p = s.blur, f = s.color, x = s.opacity, v = t.config.xaxis.crosshairs.fill.color;
                    ...
                    return h(t, [{
                        key: "getxAxisLabelsCoords", value: function () {
                            ...
                            if (e.config.xaxis.convertedCatToNumeric && 0 === i.length && (i = e.globals.categoryLabels), e.globals.timescaleLabels.length > 0) {
                                ...
                                var n = new G(this.dCtx.ctx), l = r;
                                r = n.xLabelFormat(s, r, l, {
                                    i: void 0,
                                    dateFormatter: new H(this.dCtx.ctx).formatDate,
                                    w: e
                                ...
                                var h = new y(this.dCtx.ctx),
                                    c = h.getTextRects(r, e.config.xaxis.labels.style.fontSize), d = c;
                    ...
                    return h(t, [{
                        key: "getyAxisLabelsCoords", value: function () {
                            var t = this, e = this.w, i = [], a = 10, s = new _(this.dCtx.ctx);
                            return e.config.yaxis.map((function (r, o) {
                                ...
                                if (!s.isYAxisHidden(o) && r.labels.show && void 0 !== r.labels.minWidth && (l = r.labels.minWidth), !s.isYAxisHidden(o) && r.labels.show && n.result.length) {
                                    ...
                                    if (void 0 !== g && 0 !== g.length || (g = d), e.globals.isBarHorizontal) {
                                        ...
                                        g = h(g = b.getLargestStringFromArr(p), {
                                            seriesIndex: o,
                                            dataPointIndex: -1,
                                            w: e
                                    ...
                                    g !== u && (m = f.getTextRects(u, r.labels.style.fontSize, r.labels.style.fontFamily, x, !1)), i.push({
                                        width: (l > m.width || l > v.width ? l : m.width > v.width ? m.width : v.width) + a,
                        ...
                        key: "getTotalYAxisWidth", value: function () {
                            var t = this.w, e = 0, i = 0, a = 0, s = t.globals.yAxisScale.length > 1 ? 10 : 0,
                                r = new _(this.dCtx.ctx), o = function (o, n) {
                    ...
                    return h(t, [{
                        ...
                        key: "setGridXPosForDualYAxis", value: function (t, e) {
                            var i = this.w, a = new _(this.dCtx.ctx);
                    ...
                    function t(e) {
                        n(this, t), this.ctx = e, this.w = e.w, this.lgRect = {}, this.yAxisWidth = 0, this.yAxisWidthLeft = 0, this.yAxisWidthRight = 0, this.xAxisHeight = 0, this.isSparkline = this.w.config.chart.sparkline.enabled, this.dimHelpers = new rt(this), this.dimYAxis = new nt(this), this.dimXAxis = new ot(this), this.dimGrid = new lt(this), this.lgWidthForSideLegends = 0, this.gridPad = this.w.config.grid.padding, this.xPadRight = 0, this.xPadLeft = 0
                    }
                    ...
                    function t(e, i) {
                        n(this, t), this.ctx = e, this.w = e.w, this.onLegendClick = this.onLegendClick.bind(this), this.onLegendHovered = this.onLegendHovered.bind(this), this.isBarsDistributed = "bar" === this.w.config.chart.type && this.w.config.plotOptions.bar.distributed && 1 === this.w.config.series.length, this.legendHelpers = new ct(this)
                    }
                    ...
                    return h(t, [{
                        ...
                        key: "drawLegends", value: function () {
                            ...
                            for (var o = e.globals.legendFormatter, n = e.config.legend.inverseOrder, l = n ? a.length - 1 : 0; n ? l >= 0 : l <= a.length - 1; n ? l-- : l++) {
                                ...
                                T || (T = e.config.chart.foreColor), P.style.color = T, P.style.fontSize = parseFloat(e.config.legend.fontSize) + "px", P.style.fontWeight = e.config.legend.fontWeight, P.style.fontFamily = i || e.config.chart.fontFamily, y.setAttrs(P, {
                                    rel: l + 1,
                                    i: l,
                        ...
                        key: "setLegendWrapXY", value: function (t, e) {
                            ...
                            if ("bottom" === i.config.legend.position) o += i.globals.svgHeight - s.height / 2; else if ("top" === i.config.legend.position) {
                                var n = new ht(this.ctx), l = n.dimHelpers.getTitleSubtitleCoords("title").height,
                        ...
                        key: "legendAlignHorizontal", value: function () {
                            ...
                            var e = this.legendHelpers.getLegendBBox(), i = new ht(this.ctx),
                        ...
                        key: "zoomUpdateOptions", value: function (t, e) {
                            ...
                            if (void 0 !== t || void 0 !== e) {
                                if (!(i.config.xaxis.convertedCatToNumeric && (t < 1 && (t = 1, e = i.globals.dataPoints), e - t < 2))) {
                                    ...
                                    i.config.chart.zoom.autoScaleYaxis && (o = new Z(this.ctx).autoScaleY(this.ctx, o, {xaxis: a})), i.config.chart.group || (r.yaxis = o), this.w.globals.zoomed = !0, this.ctx.updateHelpers._updateOptions(r, !1, this.w.config.chart.animations.dynamicAnimation.enabled), this.zoomCallback(a, o)
                                }
                    ...
                    function i(t) {
                        var a;
                        return n(this, i), (a = e.call(this, t)).ctx = t, a.w = t.w, a.dragged = !1, a.graphics = new y(a.ctx), a.eventList = ["mousedown", "mouseleave", "mousemove", "touchstart", "touchmove", "mouseup", "touchend"], a.clientX = 0, a.clientY = 0, a.startX = 0, a.endX = 0, a.dragX = 0, a.startY = 0, a.endY = 0, a.dragY = 0, a.moveDirection = "none", a
                    }
                    ...
                    return h(i, [{
                        ...
                        key: "selectionDrawing", value: function (t) {
                            var e, i = t.context, a = t.zoomtype, s = this.w, r = i,
                                o = this.gridRect.getBoundingClientRect(), n = r.startX - 1, l = r.startY, h = !1,
                                c = !1, d = r.clientX - o.left - n, g = r.clientY - o.top - l;
                        ...
                        key: "selectionDrawn", value: function (t) {
                            var e = t.context, i = t.zoomtype, a = this.w, s = e, r = this.xyRatios,
                                o = this.ctx.toolbar;
                            if (s.startX > s.endX) {
                                var n = s.startX;
                    ...
                    return h(t, [{
                        key: "getNearestValues", value: function (t) {
                            ...
                            })), r.globals.isXNumeric && (v = (m = this.closestInMultiArray(g, u, y, x)).index, p = m.j, null !== v && (y = r.globals.seriesXvalues[v], p = (m = this.closestInArray(g, y)).index)), r.globals.capturedSeriesIndex = null === v ? -1 : v, (!p || p < 1) && (p = 0), r.globals.isBarHorizontal ? r.globals.capturedDataPointIndex = f : r.globals.capturedDataPointIndex = p, {
                                capturedSeries: v,
                    ...
                    return h(t, [{
                        ...
                        key: "printLabels", value: function (t) {
                            var e, i = this, a = t.i, s = t.j, o = t.values, n = t.ttItems, l = t.shared, h = t.e,
                                c = this.w, d = [], g = function (t) {
                                    return c.globals.seriesGoals[t] && c.globals.seriesGoals[t][s] && Array.isArray(c.globals.seriesGoals[t][s])
                                }, u = o.xVal, p = o.zVal, f = o.xAxisTTVal, x = "", b = c.globals.colors[a];
                            ...
                            for (var v = function (t, o) {
                                ...
                                null === s && (e = v.yLbFormatter(c.globals.series[a], r(r({}, c), {}, {
                                    seriesIndex: a,
                                    dataPointIndex: a
                                }))), i.DOMHandling({
                                    i: a,
                        ...
                        key: "DOMHandling", value: function (t) {
                            t.i;
                            var e = t.t, i = t.j, a = t.ttItems, s = t.values, r = t.seriesName, o = t.shared,
                                n = t.pColor, l = this.w, h = this.ttCtx, c = s.val, d = s.goalVals, g = s.xVal,
                                u = s.xAxisTTVal, p = s.zVal, f = null;
                        ...
                        key: "getValuesToPrint", value: function (t) {
                            ...
                            var d = r;
                            return r = a.globals.isXNumeric && "datetime" === a.config.xaxis.type ? new G(this.ctx).xLabelFormat(a.globals.ttKeyFormatter, d, d, {
                                i: void 0,
                                dateFormatter: new H(this.ctx).formatDate,
                                w: this.w
                    ...
                    return h(t, [{
                        key: "moveXCrosshairs", value: function (t) {
                            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
                                i = this.ttCtx, a = this.w, s = i.getElXCrosshairs(), r = t - i.xcrosshairsWidth / 2,
                        ...
                        key: "moveTooltip", value: function (t, e) {
                            var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null, a = this.w,
                                s = this.ttCtx, r = s.getElTooltip(), o = s.tooltipRect,
                                n = null !== i ? parseFloat(i) : 1, l = parseFloat(t) + n + 5,
                                h = parseFloat(e) + n / 2;
                    ...
                    return h(t, [{
                        key: "drawDynamicPoints", value: function () {
                            var t = this.w, e = new y(this.ctx), i = new I(this.ctx),
                    ...
                    return h(t, [{
                        ...
                        key: "handleHeatTreeTooltip", value: function (t) {
                            ...
                            if (e.target.classList.contains("apexcharts-".concat(r, "-rect"))) {
                                var l = this.getAttr(e, "i"), h = this.getAttr(e, "j"), c = this.getAttr(e, "cx"),
                                    d = this.getAttr(e, "cy"), g = this.getAttr(e, "width"),
                        ...
                        key: "handleBarTooltip", value: function (t) {
                            var e, i, a = t.e, s = t.opt, r = this.w, o = this.ttCtx, n = o.getElTooltip(), l = 0,
                                h = 0, c = 0, d = this.getBarTooltipXY({e: a, opt: s});
                            e = d.i;
                        ...
                        key: "getBarTooltipXY", value: function (t) {
                            var e = t.e, i = t.opt, a = this.w, s = null, r = this.ttCtx, o = 0, n = 0, l = 0, h = 0,
                                c = 0, d = e.target.classList;
                    ...
                    return h(t, [{
                        ...
                        key: "seriesHoverByContext", value: function (t) {
                            ...
                            }, i.e = s, !i.tooltipUtil.hasBars() || r.globals.comboCharts || i.isBarShared || this.tConfig.onDatasetHover.highlightDataSeries && new Y(e).toggleSeriesOnHover(s, s.target.parentNode), i.fixedTooltip && i.drawFixedTooltipRect(), r.globals.axisCharts ? i.axisChartsTooltips({
                                e: s,
                                opt: a,
                    ...
                    return h(i, [{
                        key: "draw", value: function (t, e) {
                            ...
                            for (var n = this.graphics.group({class: "apexcharts-bar-series apexcharts-plot-series"}), l = 0, h = 0, c = function (s, o) {
                                ...
                                var v = i.graphics.group({
                                    class: "apexcharts-series",
                                    seriesName: b.escapeString(a.globals.seriesNames[x]),
                                    rel: s + 1,
                                    "data:realIndex": x
                                });
                                i.ctx.series.addCollapsedClassToSeries(v, x);
                                var m = i.graphics.group({class: "apexcharts-datalabels", "data:realIndex": x}), y = 0,
                                    w = 0, k = i.initialPositions(l, h, c, d, g, u);
                                ...
                                for (var A = 0; A < a.globals.dataPoints; A++) {
                                    var S = i.barHelpers.getStrokeWidth(s, A, x), C = {
                                        indexes: {i: s, j: A, realIndex: x, bc: o},
                                        strokeWidth: S,
                                        x: l,
                                        y: h,
                                        elSeries: v
                                    }, L = null;
                                    i.isHorizontal ? (L = i.drawStackedBarPaths(r(r({}, C), {}, {
                                        zeroW: u,
                                        barHeight: y,
                                        yDivision: d
                                    })), w = i.series[s][A] / i.invertedYRatio) : (L = i.drawStackedColumnPaths(r(r({}, C), {}, {
                                        xDivision: c,
                                        barWidth: w,
                                        zeroH: g
                                    })), y = i.series[s][A] / i.yRatio[i.yaxisIndex]), h = L.y, l = L.x, p.push(l), f.push(h);
                                ...
                                a.globals.seriesXvalues[x] = p, a.globals.seriesYvalues[x] = f, i.prevY.push(i.yArrj), i.prevYF.push(i.yArrjF), i.prevYVal.push(i.yArrjVal), i.prevX.push(i.xArrj), i.prevXF.push(i.xArrjF), i.prevXVal.push(i.xArrjVal), n.add(v)
                    ...
                    return h(i, [{
                        key: "draw", value: function (t, e) {
                            var i = this, a = this.w, s = new y(this.ctx), r = new M(this.ctx);
                            ...
                            for (var n = s.group({class: "apexcharts-".concat(a.config.chart.type, "-series apexcharts-plot-series")}), l = function (o) {
                                ...
                                var l, h, c, d, g = void 0, u = void 0, p = [], f = [],
                                    x = a.globals.comboCharts ? e[o] : o, v = s.group({
                                        class: "apexcharts-series",
                                        seriesName: b.escapeString(a.globals.seriesNames[x]),
                                        rel: o + 1,
                                        "data:realIndex": x
                        ...
                        key: "drawBoxPaths", value: function (t) {
                            ...
                            var a = t.xDivision, s = t.barWidth, r = t.zeroH, o = t.strokeWidth, n = this.w,
                                l = new y(this.ctx), h = e.i, c = e.j, d = !0,
                            ...
                            var f = this.yRatio[this.yaxisIndex], x = e.realIndex, b = this.getOHLCValue(x, c), v = r,
                                m = r;
                            b.o > b.c && (d = !1);
                    ...
                    return h(t, [{
                        ...
                        key: "determineColor", value: function (t, e, i) {
                            ...
                            var n = a.globals.colors[o], l = null, h = Math.min.apply(Math, f(a.globals.series[e])),
                        ...
                        key: "calculateDataLabels", value: function (t) {
                            var e = t.text, i = t.x, a = t.y, s = t.i, r = t.j, o = t.colorProps, n = t.fontSize,
                                l = this.w.config.dataLabels, h = new y(this.ctx), c = new X(this.ctx), d = null;
                            if (l.enabled) {
                                d = h.group({class: "apexcharts-data-labels"});
                                var g = l.offsetX, u = l.offsetY, p = i + g,
                    ...
                    function t(e, i) {
                        n(this, t), this.ctx = e, this.w = e.w, this.xRatio = i.xRatio, this.yRatio = i.yRatio, this.dynamicAnim = this.w.config.chart.animations.dynamicAnimation, this.helpers = new At(e), this.rectRadius = this.w.config.plotOptions.heatmap.radius, this.strokeWidth = this.w.config.stroke.show ? this.w.config.stroke.width : 0
                    }
                            ...
                            for (var h = n ? 0 : l.length - 1; n ? h < l.length : h >= 0; n ? h++ : h--) {
                                ...
                                for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, p = 0; p < l[h].length; p++) {
                                    var f = this.helpers.getShadeColor(e.config.chart.type, h, p, this.negRange),
                                        x = f.color, v = f.colorProps;
                                    "image" === e.config.fill.type && (x = new M(this.ctx).fillPath({
                                        seriesNumber: h,
                                        dataPointIndex: p,
                    ...
                    return h(t, [{
                        key: "draw", value: function (t) {
                            ...
                            var p = i.config.plotOptions.pie.customScale, f = i.globals.gridWidth / 2,
                                x = i.globals.gridHeight / 2, v = f - i.globals.gridWidth / 2 * p,
                        ...
                        key: "drawArcs", value: function (t, e) {
                            var i = this.w, a = new m(this.ctx), s = new y(this.ctx), r = new M(this.ctx),
                                ...
                                if (!this.initialAnim || i.globals.resized || i.globals.dataChanged ? this.animBeginArr.push(0) : (0 == (k = u / this.fullAngle * i.config.chart.animations.speed) && (k = 1), this.animDur = k + this.animDur, this.animBeginArr.push(this.animDur)), this.dynamicAnim && i.globals.dataChanged ? this.animatePaths(x, {
                                    ...
                                    if (0 !== u && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
                                        ...
                                        var P = i.globals.dataLabels.style.colors[d],
                                            T = s.group({class: "apexcharts-datalabels"}), I = s.drawText({
                                                x: A,
                                                y: S,
                                                text: C,
                                                textAnchor: "middle",
                        ...
                        key: "getPiePath", value: function (t) {
                            var e = t.me, i = t.startAngle, a = t.angle, s = t.size, r = i,
                                o = Math.PI * (r - 90) / 180, n = a + i;
                            ...
                            var l = Math.PI * (n - 90) / 180, h = e.centerX + s * Math.cos(o),
                                ...
                                p = b.polarToCartesian(e.centerX, e.centerY, e.donutSize, r), f = a > 180 ? 1 : 0,
                        ...
                        key: "drawPolarElements", value: function (t) {
                            var e = this.w, i = new Z(this.ctx), a = new y(this.ctx), s = new Ct(this.ctx),
                                r = a.group(), o = a.group(),
                    ...
                    function t(e) {
                        ...
                        var i = this.w;
                        this.graphics = new y(this.ctx), this.lineColorArr = void 0 !== i.globals.stroke.colors ? i.globals.stroke.colors : i.globals.colors, this.defaultSize = i.globals.svgHeight < i.globals.svgWidth ? i.globals.gridHeight + 1.5 * i.globals.goldenPadding : i.globals.gridWidth, this.isLog = i.config.yaxis[0].logarithmic, this.coreUtils = new A(this.ctx), this.maxValue = this.isLog ? this.coreUtils.getLogVal(i.globals.maxY, 0) : i.globals.maxY, this.minValue = this.isLog ? this.coreUtils.getLogVal(this.w.globals.minY, 0) : i.globals.minY, this.polygons = i.config.plotOptions.radar.polygons, this.strokeWidth = i.config.stroke.show ? i.config.stroke.width : 0, this.size = this.defaultSize / 2.1 - this.strokeWidth - i.config.chart.dropShadow.blur, i.config.xaxis.labels.show && (this.size = this.size - i.globals.xAxisLabelsWidth / 1.75), void 0 !== i.config.plotOptions.radar.size && (this.size = i.config.plotOptions.radar.size), this.dataRadiusOfPercent = [], this.dataRadius = [], this.angleArr = [], this.yaxisLabelsTextsPos = []
                    }

                    return h(t, [{
                        key: "draw", value: function (t) {
                            var e = this, i = this.w, a = new M(this.ctx), s = [], o = new X(this.ctx);
                            ...
                            if (this.yaxisLabels = this.graphics.group({class: "apexcharts-yaxis"}), t.forEach((function (t, n) {
                                ...
                                for (var x = 0; x < c.linePathsTo.length; x++) {
                                    var v = e.graphics.renderPaths(r(r({}, d), {}, {
                                    ...
                                    h.add(v);
                                    var y = a.fillPath({seriesNumber: n}), w = e.graphics.renderPaths(r(r({}, d), {}, {
                                    ...
                                    if (i.config.chart.dropShadow.enabled) {
                                        var k = new m(e.ctx), A = i.config.chart.dropShadow;
                        ...
                        key: "drawXAxisTexts", value: function () {
                            ...
                            return e.globals.labels.forEach((function (o, n) {
                                var l = e.config.xaxis.labels.formatter, h = new X(t.ctx);
                                if (s[n]) {
                    ...
                    return h(i, [{
                        ...
                        key: "drawTracks", value: function (t) {
                            var e = this.w, i = new y(this.ctx), a = i.group({class: "apexcharts-tracks"}),
                                s = new m(this.ctx), r = new M(this.ctx), o = this.getStrokeWidth(t);
                            t.size = t.size - o / 2;
                        ...
                        key: "drawArcs", value: function (t) {
                            var e = this.w, i = new y(this.ctx), a = new M(this.ctx), s = new m(this.ctx),
                                r = i.group(), o = this.getStrokeWidth(t);
                            t.size = t.size - o / 2;
                        ...
                        key: "drawHollowImage", value: function (t, e, i, a) {
                            var s = this.w, r = new M(this.ctx), o = b.randomId(),
                    ...
                    return h(t, [{
                        ...
                        key: "calculatePoints", value: function (t) {
                            var e = t.series, i = t.realIndex, a = t.x, s = t.y, r = t.i, o = t.j, n = t.prevY,
                                l = this.w, h = [], c = [];
                            if (0 === o) {
                    ...
                    function t(e, i, a) {
                        n(this, t), this.ctx = e, this.w = e.w, this.xyRatios = i, this.pointsChart = !("bubble" !== this.w.config.chart.type && "scatter" !== this.w.config.chart.type) || a, this.scatter = new z(this.ctx), this.noNegatives = this.w.globals.minX === Number.MAX_VALUE, this.lineHelpers = new Mt(this), this.markers = new I(this.ctx), this.prevSeriesY = [], this.categoryAxisCorrection = 0, this.yaxisIndex = 0
                    }
                    ...
                    return h(t, [{
                        key: "draw", value: function (t, e, i) {
                            ...
                            if (a.config.chart.stacked) for (var w = l.length; w > 0; w--) o.add(l[w - 1]); else for (var k = 0; k < l.length; k++) o.add(l[k]);
                            return o
                        }
                    }, {
                        ...
                        key: "_calculatePathsFrom", value: function (t) {
                            var e, i, a, s, r = t.series, o = t.i, n = t.realIndex, l = t.prevX, h = t.prevY,
                                c = this.w, d = new y(this.ctx);
                            if (null === r[o][0]) {
                        ...
                        key: "_handlePaths", value: function (t) {
                            var e = t.type, i = t.realIndex, a = t.i, s = t.paths, o = this.w, n = new y(this.ctx),
                                l = new M(this.ctx);
                        ...
                        key: "_iterateOverDataPoints", value: function (t) {
                            for (var e = t.series, i = t.realIndex, a = t.i, s = t.x, r = t.y, o = t.pX, n = t.pY, l = t.pathsFrom, h = t.linePaths, c = t.areaPaths, d = t.seriesIndex, g = t.lineYPosition, u = t.xArrj, p = t.yArrj, f = this.w, x = new y(this.ctx), v = this.yRatio, m = l.prevY, w = l.linePath, k = l.areaPath, A = l.pathFromLine, S = l.pathFromArea, C = b.isNumber(f.globals.minYArr[i]) ? f.globals.minYArr[i] : f.globals.minY, L = f.globals.dataPoints > 1 ? f.globals.dataPoints - 1 : f.globals.dataPoints, P = 0; P < L; P++) {
                                ...
                                g = f.config.chart.stacked && a > 0 && f.globals.collapsedSeries.length < f.config.series.length - 1 ? this.prevSeriesY[function (t) {
                                    ...
                                    return e >= 0 ? e : 0
                                }(a - 1)][P + 1] : this.zeroY, r = T ? g - C / v[this.yaxisIndex] + 2 * (this.isReversed ? C / v[this.yaxisIndex] : 0) : g - e[a][P + 1] / v[this.yaxisIndex] + 2 * (this.isReversed ? e[a][P + 1] / v[this.yaxisIndex] : 0), u.push(s), p.push(r);
                                ...
                                c = z.areaPaths, h = z.linePaths, o = z.pX, n = z.pY, k = z.areaPath, w = z.linePath, this.appendPathFrom && (A += x.line(s, this.zeroY), S += x.line(s, this.zeroY)), this.handleNullDataPoints(e, I, a, P, i), this._handleMarkersAndLabels({
                                    pointsPos: I,
                                    series: e,
                                    x: s,
                                    y: r,
                        ...
                        key: "_handleMarkersAndLabels", value: function (t) {
                            ...
                            var i = t.i, a = t.j, s = t.realIndex, r = this.w, o = new X(this.ctx);
                        ...
                        key: "_createPaths", value: function (t) {
                            var e = t.series, i = t.i, a = t.realIndex, s = t.j, r = t.x, o = t.y, n = t.pX, l = t.pY,
                                ...
                                p = this.w, f = new y(this.ctx), x = p.config.stroke.curve, b = this.areaBottomY;
                ...
                var zt, Xt, Et = function () {
                    ...
                    return h(t, [{
                        key: "draw", value: function (t) {
                            var e = this, i = this.w, a = new y(this.ctx), s = new M(this.ctx),
                        ...
                        key: "rotateToFitLabel", value: function (t, e, i, a, s, r) {
                            var o = new y(this.ctx), n = o.getTextRects(e);
                    ...
                    return h(t, [{
                        key: "calculateTimeScaleTicks", value: function (t, e) {
                            ...
                            var s = new H(this.ctx), o = (e - t) / 864e5;
                            this.determineInterval(o), a.globals.disableZoomIn = !1, a.globals.disableZoomOut = !1, o < .00011574074074074075 ? a.globals.disableZoomIn = !0 : o > 5e4 && (a.globals.disableZoomOut = !0);
                            var n = s.getTimeUnitsfromTimestamp(t, e, this.utc), l = a.globals.gridWidth / o,
                                h = l / 24, c = h / 60, d = c / 60, g = Math.floor(24 * o), u = Math.floor(1440 * o),
                                p = Math.floor(86400 * o), f = Math.floor(o), x = Math.floor(o / 30),
                                b = Math.floor(o / 365), v = {
                            ...
                            var y = this.timeScaleArray.map((function (t) {
                                ...
                                return "month" === t.unit ? r(r({}, e), {}, {
                                    day: 1,
                                    value: t.value + 1
                                }) : "day" === t.unit || "hour" === t.unit ? r(r({}, e), {}, {value: t.value}) : "minute" === t.unit ? r(r({}, e), {}, {
                                    value: t.value,
                                    minute: t.value
                                }) : "second" === t.unit ? r(r({}, e), {}, {
                                    value: t.value,
                        ...
                        key: "generateYearScale", value: function (t) {
                            var e = t.firstVal, i = t.currentMonth, a = t.currentYear, s = t.daysWidthOnXAxis,
                                r = t.numberOfYears, o = e.minYear, n = 0, l = new H(this.ctx), h = "year";
                        ...
                        key: "generateMonthScale", value: function (t) {
                            var e = t.firstVal, i = t.currentMonthDate, a = t.currentMonth, s = t.currentYear,
                                r = t.daysWidthOnXAxis, o = t.numberOfMonths, n = a, l = 0, h = new H(this.ctx),
                                c = "month", d = 0;
                            if (e.minDate > 1) {
                        ...
                        key: "generateDayScale", value: function (t) {
                            var e = t.firstVal, i = t.currentMonth, a = t.currentYear, s = t.hoursWidthOnXAxis,
                                r = t.numberOfDays, o = new H(this.ctx), n = "day", l = e.minDate + 1, h = l,
                                c = function (t, e, i) {
                                    return t > o.determineDaysOfMonths(e + 1, i) ? (h = 1, n = "month", g = e += 1, e) : e
                                }, d = (24 - e.minHour) * s, g = l, u = c(h, i, a);
                            0 === e.minHour && 1 === e.minDate ? (d = 0, g = b.monthMod(e.minMonth), n = "month", h = e.minDate, r++) : 1 !== e.minDate && 0 === e.minHour && 0 === e.minMinute && (d = 0, l = e.minDate, g = l, u = c(h = l, i, a)), this.timeScaleArray.push({
                                position: d,
                                value: g,
                                unit: n,
                        ...
                        key: "generateHourScale", value: function (t) {
                            var e = t.firstVal, i = t.currentDate, a = t.currentMonth, s = t.currentYear,
                                r = t.minutesWidthOnXAxis, o = t.numberOfHours, n = new H(this.ctx), l = "hour",
                                h = function (t, e) {
                        ...
                        key: "formatDates", value: function (t) {
                            ...
                            return t.map((function (t) {
                                var a = t.value.toString(), s = new H(e.ctx), r = e.createRawDateString(t, a),
                    ...
                    return h(t, [{
                        ...
                        key: "plotChartType", value: function (t, e) {
                            var i = this.w, a = i.config, s = i.globals, r = {series: [], i: []},
                                o = {series: [], i: []}, n = {series: [], i: []}, l = {series: [], i: []},
                                h = {series: [], i: []}, c = {series: [], i: []}, d = {series: [], i: []};
                        ...
                        key: "resizeNonAxisCharts", value: function () {
                            ...
                            a += t.config.grid.padding.bottom, "top" !== t.config.legend.position && "bottom" !== t.config.legend.position || !t.config.legend.show || t.config.legend.floating || (i = new dt(this.ctx).legendHelpers.getLegendBBox().clwh + 10);
                        ...
                        key: "xySettings", value: function () {
                            ...
                            if (e.globals.axisCharts) {
                                if ("back" === e.config.xaxis.crosshairs.position && new et(this.ctx).drawXCrosshairs(), "back" === e.config.yaxis[0].crosshairs.position && new et(this.ctx).drawYCrosshairs(), "datetime" === e.config.xaxis.type && void 0 === e.config.xaxis.labels.formatter) {
                        ...
                        key: "setupBrushHandler", value: function () {
                            ...
                            if (e.config.chart.brush.enabled && "function" != typeof e.config.chart.events.selection) {
                                ...
                                i.forEach((function (e) {
                                    ...
                                    i.forEach((function (t) {
                                        var i = ApexCharts.getChartByID(t), s = b.clone(e.config.yaxis);
                                        ...
                                        var n = i.w.config.yaxis.reduce((function (t, e, a) {
                                            return [].concat(f(t), [r(r({}, i.w.config.yaxis[a]), {}, {
                                                min: s[0].min,
                                                max: s[0].max
                                            })])
                                        }), []);
                    ...
                    return h(t, [{
                        key: "_updateOptions", value: function (t) {
                            ...
                            s && (n = this.ctx.getSyncedCharts()), this.ctx.w.globals.isExecCalled && (n = [this.ctx], this.ctx.w.globals.isExecCalled = !1), n.forEach((function (s) {
                                var n = s.w;
                                return n.globals.shouldAnimate = a, i || (n.globals.resized = !0, n.globals.dataChanged = !0, a && s.series.getPreviousPaths()), t && "object" === o(t) && (s.config = new O(t), t = A.extendArrayProps(s.config, t, n), s.w.globals.chartID !== e.ctx.w.globals.chartID && delete t.series, n.config = b.extend(n.config, t), r && (n.globals.lastXAxis = t.xaxis ? b.clone(t.xaxis) : [], n.globals.lastYAxis = t.yaxis ? b.clone(t.yaxis) : [], n.globals.initialConfig = b.extend({}, n.config), n.globals.initialSeries = b.clone(n.config.series))), s.update(t)
                            }))
                        }
                    }, {
                        key: "_updateSeries", value: function (t, e) {
                            ...
                            }))).length && (i = [{data: []}]), r.config.series = i) : r.config.series = t.slice(), s && (r.globals.initialSeries = b.clone(r.config.series)), this.ctx.update()
                        }
                    }, {
                        key: "_extendSeries", value: function (t, e) {
                            var i = this.w, a = i.config.series[e];
                            return r(r({}, i.config.series[e]), {}, {
                ...
                zt = "undefined" != typeof window ? window : void 0, Xt = function (t, e) {
                    ...
                    i.PathArray = function (t, e) {
                        ...
                        attr: function (t, e, i) {
                            if ("object" === o(t)) for (var a in t) this.attr(a, t[a]); else this.add(t, e, "attrs");
                            return this
                        ...
                        create: function (t, e, a, s) {
                            ...
                            4 == arguments.length && (this.x = t, this.y = e, this.width = a, this.height = s), function (t) {
                        ...
                        create: function (t) {
                            var e = f([1, 0, 0, 1, 0, 0]);
                            t = null === t ? e : t instanceof i.Element ? t.matrixify() : "string" == typeof t ? f(t.split(i.regex.delimiter).map(parseFloat)) : 6 == arguments.length ? f([].slice.call(arguments)) : Array.isArray(t) ? f(t) : t && "object" === o(t) ? t : e;
                        ...
                        create: function (t, e) {
                            var i;
                            i = Array.isArray(t) ? {x: t[0], y: t[1]} : "object" === o(t) ? {
                                x: t.x,
                                y: t.y
                        ...
                        attr: function (t, e, a) {
                            ...
                            if ("object" === o(t)) for (var s in t) this.attr(s, t[s]); else if (null === e) this.node.removeAttribute(t); else {
                        ...
                        transform: function (t, e) {
                            var a;
                            return "object" !== o(t) ? (a = new i.Matrix(this).extract(), "string" == typeof t ? a[t] : a) : (a = new i.Matrix(this), e = !!e || !!t.relative, null != t.a && (a = e ? a.multiply(new i.Matrix(t)) : new i.Matrix(t)), this.attr("transform", a))
                        }
                    }), i.extend(i.Element, {
                        ...
                        create: function (t, e) {
                            ...
                            if (Array.isArray(t)) for (var i = 0, a = this.arguments.length; i < a; ++i) this[this.arguments[i]] = t[i]; else if (t && "object" === o(t)) for (i = 0, a = this.arguments.length; i < a; ++i) this[this.arguments[i]] = t[this.arguments[i]];
                        ...
                        style: function (t, e) {
                            ...
                            if (arguments.length < 2) if ("object" === o(t)) for (var a in t) this.style(a, t[a]); else {
                        ...
                        var o = a.bind(s || t.instance || t),
                            n = (i.handlerMap.indexOf(t) + 1 || i.handlerMap.push(t)) - 1, l = e.split(".")[0],
                            h = e.split(".")[1] || "*";
                    ...
                    ["fill", "stroke"].forEach((function (t) {
                        ...
                        remember: function (t, e) {
                            if ("object" === o(arguments[0])) for (var i in t) this.remember(i, t[i]); else {
                            ...
                            case"A":
                                t = (e = function (t, e) {
                                    var i, a, s, r, o, n, l, h, c, d, g, u, p, f, x, b, v, m, y, w, k, A, S, C, L, P,
                                        T = Math.abs(e[1]), M = Math.abs(e[2]), I = e[3] % 360, z = e[4], X = e[5],
                ...
                var Ht = function () {
                    ...
                    return h(t, [{
                        ...
                        key: "create", value: function (t, e) {
                            ...
                            var n = this.core.plotChartType(t, o), l = new X(this);
                        ...
                        key: "mount", value: function () {
                            ...
                            return new Promise((function (s, r) {
                                ...
                                var n = new U(t.ctx), l = new J(t.ctx);
                        ...
                        key: "getChartByID", value: function (t) {
                            var e = b.escapeString(t), i = Apex._chartInstances.filter((function (t) {
                                return t.id === e
                            }))[0];
                            return i && i.chart
                        }

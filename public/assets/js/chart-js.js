...
!function (t, e) {
    ...
    return function () {
        ...
        const l = {
                ...
                e: 14,
                f: 15
            }, h = [..."0123456789ABCDEF"], c = t => h[15 & t], d = t => h[(240 & t) >> 4] + h[15 & t],
            u = t => (240 & t) >> 4 == (15 & t);
        ...
        function M(t) {
            ...
            const a = v(+e[2]), r = +e[3] / 100, l = +e[4] / 100;
            return i = "hwb" === e[1] ? function (t, e, i) {
                return _(b, t, e, i)
            }(a, r, l) : "hsv" === e[1] ? function (t, e, i) {
                return _(m, t, e, i)
            }(a, r, l) : y(a, r, l), {r: i[0], g: i[1], b: i[2], a: s}
        }
        ...
        function P(t) {
            S || (S = function () {
                const t = {}, e = Object.keys(k), i = Object.keys(w);
                let s, n, o, a, r;
        ...
        function L(t) {
            ...
            return Array.isArray(t) ? t.length >= 3 && (e = {
                ...
                b: t[2],
                a: 255
            }, t.length > 3 && (e.a = o(t[3]))) : (e = T(t, {r: 0, g: 0, b: 0, a: 1})).a = o(e.a), e
        }
        ...
        class R {
            constructor(t) {
                ...
                })), i = n || P(t) || E(t)), this._rgb = i, this._valid = !!i
            }
            ...
            hslString() {
                return this._valid ? function (t) {
                    if (!t) return;
                    const e = x(t), i = e[0], s = r(e[1]), n = r(e[2]);
            ...
            interpolate(t, e) {
                return t && (this._rgb = function (t, e, i) {
                    const s = C(a(t.r)), n = C(a(t.g)), r = C(a(t.b));
                    return {
                        r: o(O(s + i * (C(a(e.r)) - s))),
                        g: o(O(n + i * (C(a(e.g)) - n))),
                        b: o(O(r + i * (C(a(e.b)) - r))),
            ...
            greyscale() {
                const t = this._rgb, e = i(.3 * t.r + .59 * t.g + .11 * t.b);
        ...
        function Y(t, e, i, s) {
            let n, o, a;
            if (V(t)) if (o = t.length, s) for (n = o - 1; n >= 0; n--) e.call(i, t[n], n); else for (n = 0; n < o; n++) e.call(i, t[n], n); else if (B(t)) for (a = Object.keys(t), o = a.length, n = 0; n < o; n++) e.call(i, t[a[n]], a[n])
        }
        ...
        const it = t => void 0 !== t, st = t => "function" == typeof t, nt = (t, e) => {
            if (t.size !== e.size) return !1;
            for (const i of t) if (!e.has(i)) return !1;
            return !0
        };
        const ot = Math.PI, at = 2 * ot, rt = at + ot, lt = Number.POSITIVE_INFINITY, ht = ot / 180, ct = ot / 2,
            dt = ot / 4, ut = 2 * ot / 3, ft = Math.log10, gt = Math.sign;
        ...
        function Pt(t, e, i, s) {
            const n = St(t), o = St(e), a = St(i), r = St(o - n), l = St(a - n), h = St(n - o), c = St(n - a);
        ...
        } : s => t[s][e] < i), Tt = (t, e, i) => Ct(t, i, (s => t[s][e] >= i));
        ...
        function Et(t, e) {
            ...
            -1 !== n && s.splice(n, 1), s.length > 0 || (Lt.forEach((e => {
                delete t[e]
            })), delete t._chartjs)
        }
        ...
        function Bt(t, e, i) {
            ...
            if (t._sorted) {
                ...
                d && (n = Dt(Math.min(At(r, l, h).lo, i ? s : At(e, l, a.getPixelForValue(h)).lo), 0, s - 1)), o = u ? Dt(Math.max(At(r, a.axis, c, !0).hi + 1, i ? 0 : At(e, l, a.getPixelForValue(c), !0).hi + 1), n, s) - n : s - n
            }
        ...
        const Nt = t => 0 === t || 1 === t, Ht = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * at / i),
            jt = (t, e, i) => Math.pow(2, -10 * t) * Math.sin((t - e) * at / i) + 1, $t = {
                linear: t => t,
                easeInQuad: t => t * t,
                easeOutQuad: t => -t * (t - 2),
        ...
        const qt = ["x", "y", "borderWidth", "radius", "tension"], Kt = ["color", "borderColor", "backgroundColor"];
        const Gt = new Map;
        ...
        const Jt = {
            values(t) {
                ...
                const a = ft(Math.abs(o)), r = isNaN(a) ? 1 : Math.max(Math.min(-1 * Math.floor(a), 20), 0),
                    l = {notation: n, minimumFractionDigits: r, maximumFractionDigits: r};
                return Object.assign(l, this.options.ticks.format), Zt(t, s, l)
            }, logarithmic(t, e, i) {
                if (0 === t) return "0";
        ...
        class ne {
            constructor(t, e) {
                this.animation = void 0, this.backgroundColor = "rgba(0,0,0,0.1)", this.borderColor = "rgba(0,0,0,0.1)", this.color = "#666", this.datasets = {}, this.devicePixelRatio = t => t.chart.platform.getDevicePixelRatio(), this.elements = {}, this.events = ["mousemove", "mouseout", "click", "touchstart", "touchmove"], this.font = {
                    ...
                    lineHeight: 1.2,
                    weight: null
                }, this.hover = {}, this.hoverBackgroundColor = (t, e) => Xt(e.backgroundColor), this.hoverBorderColor = (t, e) => Xt(e.borderColor), this.hoverColor = (t, e) => Xt(e.color), this.indexAxis = "x", this.interaction = {
                    mode: "nearest",
                    intersect: !0,
                    includeInvisible: !1
            ...
            route(t, e, i, s) {
                const n = ie(this, t), o = ie(this, i), a = "_" + e;
        ...
        function re(t, e, i, s) {
            ...
            const r = i.length;
            let l, h, c, d, u;
            for (l = 0; l < r; l++) if (d = i[l], null == d || V(d)) {
                if (V(d)) for (h = 0, c = d.length; h < c; h++) u = d[h], null == u || V(u) || (a = ae(t, n, o, a, u))
            } else a = ae(t, n, o, a, d);
            t.restore();
            const f = o.length / 2;
            if (f > i.length) {
            ...
            if (!(isNaN(p) || p <= 0)) {
                switch (t.beginPath(), f) {
                    default:
                        ...
                        break;
                    case"triangle":
                        c = n ? n / 2 : p, t.moveTo(i + Math.sin(m) * c, s - Math.cos(m) * p), m += ut, t.lineTo(i + Math.sin(m) * c, s - Math.cos(m) * p), m += ut, t.lineTo(i + Math.sin(m) * c, s - Math.cos(m) * p), t.closePath();
                        break;
                    case"rectRounded":
                        h = .516 * p, l = p - h, a = Math.cos(m + dt) * l, d = Math.cos(m + dt) * (n ? n / 2 - h : l), r = Math.sin(m + dt) * l, u = Math.sin(m + dt) * (n ? n / 2 - h : l), t.arc(i - d, s - r, h, m - ot, m - ct), t.arc(i + u, s - a, h, m - ct, m), t.arc(i + d, s + r, h, m, m + ct), t.arc(i - u, s + a, h, m + ct, m + ot), t.closePath();
                        break;
                    case"rect":
                        if (!g) {
                    ...
                    case"cross":
                        ...
                        break;
                    case"star":
                        d = Math.cos(m) * (n ? n / 2 : p), a = Math.cos(m) * p, r = Math.sin(m) * p, u = Math.sin(m) * (n ? n / 2 : p), t.moveTo(i - d, s - r), t.lineTo(i + d, s + r), t.moveTo(i + u, s - a), t.lineTo(i - u, s + a), m += dt, d = Math.cos(m) * (n ? n / 2 : p), a = Math.cos(m) * p, r = Math.sin(m) * p, u = Math.sin(m) * (n ? n / 2 : p), t.moveTo(i - d, s - r), t.lineTo(i + d, s + r), t.moveTo(i + u, s - a), t.lineTo(i - u, s + a);
                        break;
                    case"line":
        ...
        function _e(t, e, i, s, n, o = {}) {
            const a = V(e) ? e : [e], r = o.strokeWidth > 0 && "" !== o.strokeColor;
            let l, h;
            ...
            }(t, o), l = 0; l < a.length; ++l) h = a[l], o.backdrop && xe(t, o.backdrop), r && (o.strokeColor && (t.strokeStyle = o.strokeColor), F(o.strokeWidth) || (t.lineWidth = o.strokeWidth), t.strokeText(h, i, s, o.maxWidth)), t.fillText(h, i, s, o.maxWidth), be(t, i, s, h, o), s += Number(n.lineHeight);
            t.restore()
        }

        function ye(t, e) {
            const {x: i, y: s, w: n, h: o, radius: a} = e;
            t.arc(i + a.topLeft, s + a.topLeft, a.topLeft, -ct, ot, !0), t.lineTo(i, s + o - a.bottomLeft), t.arc(i + a.bottomLeft, s + o - a.bottomLeft, a.bottomLeft, ot, ct, !0), t.lineTo(i + n - a.bottomRight, s + o), t.arc(i + n - a.bottomRight, s + o - a.bottomRight, a.bottomRight, ct, 0, !0), t.lineTo(i + n, s + a.topRight), t.arc(i + n - a.topRight, s + a.topRight, a.topRight, 0, -ct, !0), t.lineTo(i + a.topLeft, s)
        }
        ...
        function Se(t, e) {
            const i = {}, s = B(e), n = s ? Object.keys(e) : e,
                o = B(t) ? s ? i => H(t[i], t[e[i]]) : e => t[e] : () => t;
            for (const t of n) i[t] = ke(o(t));
            return i
        }
        ...
        function Ce(t, e) {
            ...
            s && !("" + s).match(Me) && (console.warn('Invalid font style specified: "' + s + '"'), s = void 0);
            const n = {
        ...
        function Ae(t, e, i, s) {
            let n, o, a, r = !0;
            for (n = 0, o = t.length; n < o; ++n) if (a = t[n], void 0 !== a && (void 0 !== e && "function" == typeof a && (a = a(e), r = !1), void 0 !== i && V(a) && (a = a[i % a.length], r = !1), void 0 !== a)) return s && !r && (s.cacheable = !1), a
        }
        ...
        function Le(t, e = [""], i, s, n = (() => t[0])) {
            const o = i || t;
            void 0 === s && (s = je("_fallback", t));
            const a = {
                ...
                _fallback: s,
                _getTarget: n,
                override: i => Le([i, ...t], e, o, s)
            };
            return new Proxy(a, {
                deleteProperty(e, i) {
                    return delete e[i], delete e._keys, delete t[0][i], !0
                }, get(i, s) {
                    return Fe(i, s, (() => function (t, e, i, s) {
                        let n;
                        for (const o of e) if (n = je(Ie(o, t), i), void 0 !== n) return ze(t, n) ? Ne(i, s, t, n) : n
                    }(s, e, t, i)))
                ...
                deleteProperty(e, i) {
                    ...
                    return Fe(t, e, (() => function (t, e, i) {
                        ...
                        st(r) && a.isScriptable(e) && (r = function (t, e, i, s) {
                            ...
                            r.add(t);
                            let l = e(o, a || s);
                            r.delete(t), ze(t, l) && (l = Ne(n._scopes, n, t, l));
                            return l
                        }(e, r, t, i));
                        V(r) && r.length && (r = function (t, e, i, s) {
                            ...
                            if (B(e[0])) {
                                ...
                                for (const l of i) {
                                    const i = Ne(s, n, t, l);
                                    e.push(Ee(i, o, a && a[t], r))
                                }
                            }
                            return e
                        }(e, r, t, a.isIndexable));
                        ze(e, r) && (r = Ee(r, n, o && o[e], a));
                        return r
                    }(t, e, i)))
        ...
        function Re(t, e = {scriptable: !0, indexable: !0}) {
        ...
        const Ie = (t, e) => t ? t + et(e) : e,
            ze = (t, e) => B(e) && "adapters" !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
        ...
        const Be = (t, e) => !0 === t ? e : "string" == typeof t ? tt(e, t) : void 0;
        ...
        function Ne(t, e, i, s) {
            const n = e._rootScopes, o = Ve(e._fallback, i, s), a = [...t, ...n], r = new Set;
            r.add(s);
            let l = He(r, a, i, o || i, s);
            return null !== l && ((void 0 === o || o === i || (l = He(r, a, o, l, s), null !== l)) && Le(Array.from(r), [""], n, o, (() => function (t, e, i) {
        ...
        function Ye(t, e, i, s) {
            ...
            let r, l, h, c;
            for (r = 0, l = s; r < l; ++r) h = r + i, c = e[h], a[r] = {r: n.parse(tt(c, o), h)};
            return a
        }

        const Ue = Number.EPSILON || 1e-14, Xe = (t, e) => e < t.length && !t[e].skip && t[e],
            qe = t => "x" === t ? "y" : "x";

        function Ke(t, e, i, s) {
            const n = t.skip ? e : t, o = e, a = i.skip ? e : i, r = wt(o, n), l = wt(a, o);
            let h = r / (r + l), c = l / (r + l);
        ...
        function Ge(t, e = "x") {
            const i = qe(e), s = t.length, n = Array(s).fill(0), o = Array(s);
            let a, r, l, h = Xe(t, 0);
            for (a = 0; a < s; ++a) if (r = l, l = h, h = Xe(t, a + 1), l) {
                if (h) {
                    const t = h[e] - l[e];
                    n[a] = 0 !== t ? (h[i] - l[i]) / t : 0
                }
                o[a] = r ? h ? gt(n[a - 1]) !== gt(n[a]) ? 0 : (n[a - 1] + n[a]) / 2 : n[a - 1] : n[a]
            }
            !function (t, e, i) {
                const s = t.length;
                let n, o, a, r, l, h = Xe(t, 0);
                for (let c = 0; c < s - 1; ++c) l = h, h = Xe(t, c + 1), l && h && (pt(e[c], 0, Ue) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c], o = i[c + 1] / e[c], r = Math.pow(n, 2) + Math.pow(o, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[c] = n * a * e[c], i[c + 1] = o * a * e[c])))
            }(t, n, o), function (t, e, i = "x") {
                const s = qe(i), n = t.length;
                let o, a, r, l = Xe(t, 0);
                for (let h = 0; h < n; ++h) {
                    if (a = r, r = l, l = Xe(t, h + 1), !r) continue;
                    const n = r[i], c = r[s];
        ...
        function Je(t, e, i, s, n) {
            let o, a, r, l;
            if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode) Ge(t, n); else {
                let i = s ? t[t.length - 1] : t[0];
                for (o = 0, a = t.length; o < a; ++o) r = t[o], l = Ke(i, r, t[Math.min(o + 1, a - (s ? 0 : 1)) % a], e.tension), r.cp1x = l.previous.x, r.cp1y = l.previous.y, r.cp2x = l.next.x, r.cp2y = l.next.y, i = r
            }
            e.capBezierPoints && function (t, e) {
                let i, s, n, o, a, r = ue(t[0], e);
                for (i = 0, s = t.length; i < s; ++i) a = o, o = r, r = i < s - 1 && ue(t[i + 1], e), o && (n = t[i], a && (n.cp1x = Ze(n.cp1x, e.left, e.right), n.cp1y = Ze(n.cp1y, e.top, e.bottom)), r && (n.cp2x = Ze(n.cp2x, e.left, e.right), n.cp2y = Ze(n.cp2y, e.top, e.bottom)))
            }(t, i)
        }
        ...
        const si = ["top", "right", "bottom", "left"];
        ...
        const oi = (t, e, i) => (t > 0 || e > 0) && (!i || !i.shadowRoot);

        function ai(t, e) {
            if ("native" in t) return t;
            const {canvas: i, currentDevicePixelRatio: s} = e, n = ii(i), o = "border-box" === n.boxSizing,
                a = ni(n, "padding"), r = ni(n, "border", "width"), {x: l, y: h, box: c} = function (t, e) {
                    const i = t.touches, s = i && i.length ? i[0] : t, {offsetX: n, offsetY: o} = s;
                    let a, r, l = !1;
                    if (oi(n, o, t.target)) a = n, r = o; else {
        ...
        function li(t, e, i, s) {
            const n = ii(t), o = ni(n, "margin"), a = ei(n.maxWidth, t, "clientWidth") || lt,
                r = ei(n.maxHeight, t, "clientHeight") || lt, l = function (t, e, i) {
                    let s, n;
                    if (void 0 === e || void 0 === i) {
                        const o = ti(t);
                        if (o) {
                            const t = o.getBoundingClientRect(), a = ii(o), r = ni(a, "border", "width"),
                                l = ni(a, "padding");
                            e = t.width - l.width - r.width, i = t.height - l.height - r.height, s = ei(a.maxWidth, o, "clientWidth"), n = ei(a.maxHeight, o, "clientHeight")
            ...
            if ("content-box" === n.boxSizing) {
                const t = ni(n, "border", "width"), e = ni(n, "padding");
                h -= e.width + t.width, c -= e.height + t.height
            }
            h = Math.max(0, h - o.width), c = Math.max(0, s ? h / s : c - o.height), h = ri(Math.min(h, a, l.maxWidth)), c = ri(Math.min(c, r, l.maxHeight)), h && !c && (c = ri(h / 2));
            return (void 0 !== e || void 0 !== i) && s && l.height && c > l.height && (c = l.height, h = ri(Math.floor(c * s))), {
                width: h,
                height: c
            }
        }
        ...
        function gi(t, e, i, s) {
            const n = {x: t.cp2x, y: t.cp2y}, o = {x: e.cp1x, y: e.cp1y}, a = ui(t, n, i), r = ui(n, o, i),
                l = ui(o, e, i), h = ui(a, r, i), c = ui(r, l, i);
            return ui(h, c, i)
        }
        ...
        function xi(t) {
            return "angle" === t ? {between: Pt, compare: kt, normalize: St} : {
                between: Ot,
                compare: (t, e) => t - e,
                normalize: t => t
            }
        ...
        function _i({start: t, end: e, count: i, loop: s, style: n}) {
        ...
        function yi(t, e, i) {
            ...
            const {property: s, start: n, end: o} = i, a = e.length, {
                ...
                between: l,
                normalize: h
            } = xi(s), {start: c, end: d, loop: u, style: f} = function (t, e, i) {
                const {property: s, start: n, end: o} = i, {between: a, normalize: r} = xi(s), l = e.length;
            ...
            for (let t = c, i = c; t <= d; ++t) m = e[t % a], m.skip || (p = h(m[s]), p !== b && (x = l(p, n, o), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(_i({
                start: _,
                end: t,
                loop: u,
                count: a,
            ...
            return null !== _ && g.push(_i({start: _, end: d, loop: u, count: a, style: f})), g
        }

        function vi(t, e) {
            const i = [], s = t.segments;
            for (let n = 0; n < s.length; n++) {
                const o = yi(s[n], t.points, e);
                o.length && i.push(...o)
            }
            return i
        }
                ...
                for (const t of e) {
                    ...
                    for (u = d + 1; u <= t.end; u++) {
                        ...
                        e = wi(s.setContext(Te(n, {
                            ...
                            p1DataIndex: u % l,
                            datasetIndex: a
                        }))), ki(e, c) && f(d, u - 1, t.loop, c), o = r, c = e
                    }
        ...
        var Pi = new Si;
        const Di = "transparent", Oi = {
            boolean(t, e, i) {
                return i > .5 ? e : t
            }, color(t, e, i) {
                const s = Ut(t || Di), n = s.valid && Ut(e || Di);
        ...
        class Ci {
            constructor(t, e, i, s) {
                ...
                this._active = !0, this._fn = t.fn || Oi[t.type || typeof o], this._easing = $t[t.easing] || $t.linear, this._start = Math.floor(Date.now() + (t.delay || 0)), this._duration = this._total = Math.floor(t.duration), this._loop = !!t.loop, this._target = e, this._prop = i, this._from = o, this._to = s, this._promises = void 0
            }
        ...
        class Ai {
            ...
            _createAnimations(t, e) {
                ...
                for (r = o.length - 1; r >= 0; --r) {
                    ...
                    d && d.duration ? (n[l] = c = new Ci(d, t, l, h), s.push(c)) : t[l] = h
                }
                return s
            }
        ...
        function Ei(t, e, i, s = {}) {
            ...
            if (null !== e) {
                for (a = 0, r = n.length; a < r; ++a) {
                    ...
                    h = t.values[l], W(h) && (o || 0 === e || gt(e) === gt(h)) && (e += h)
                }
                return e
            }
        }
        ...
        function Fi(t, e) {
            ...
            for (let t = 0; t < d; ++t) {
                ...
                u = (i._stacks || (i._stacks = {}))[h] = Ii(n, c, o), u[r] = d, u._top = zi(u, a, !0, s.type), u._bottom = zi(u, a, !1, s.type);
        ...
        const Wi = t => "reset" === t || "none" === t, Ni = (t, e) => e ? t : Object.assign({}, t);
        ...
        class Hi {
            ...
            linkScales() {
                const t = this.chart, e = this._cachedMeta, i = this.getDataset(),
                    s = (t, e, i, s) => "x" === t ? e : "r" === t ? s : i, n = e.xAxisID = H(i.xAxisID, Vi(t, "x")),
                    o = e.yAxisID = H(i.yAxisID, Vi(t, "y")), a = e.rAxisID = H(i.rAxisID, Vi(t, "r")), r = e.indexAxis,
            ...
            _destroy() {
                const t = this._cachedMeta;
                this._data && Et(this._data, this), t._stacked && Bi(t)
            }

            _dataCheck() {
                const t = this.getDataset(), e = t.data || (t.data = []), i = this._data;
                if (B(e)) this._data = function (t) {
            ...
            buildOrUpdateElements(t) {
                ...
                this._dataCheck();
                const n = e._stacked;
                e._stacked = Ri(e.vScale, e), e.stack !== i.stack && (s = !0, Bi(e), e.stack = i.stack), this._resyncElements(t), (s || n !== e._stacked) && Fi(this, e._parsed)
            }
            ...
            parse(t, e) {
                ...
                if (!1 === this._parsing) i._parsed = s, i._sorted = !0, h = s; else {
                    h = V(s[t]) ? this.parseArrayData(i, s, t, e) : B(s[t]) ? this.parseObjectData(i, s, t, e) : this.parsePrimitiveData(i, s, t, e);
            ...
            parsePrimitiveData(t, e, i, s) {
                const {iScale: n, vScale: o} = t, a = n.axis, r = o.axis, l = n.getLabels(), h = n === o,
                    c = new Array(s);
                let d, u, f;
            ...
            applyStack(t, e, i) {
                ...
                return Ei({keys: Li(s, !0), values: e._stacks[t.axis]._visualValues}, o, n.index, {mode: i})
            }
            ...
            updateRangeFromParsed(t, e, i, s) {
                ...
                s && a && (s.values = a, o = Ei(s, n, this._cachedMeta.index)), t.min = Math.min(t.min, o), t.max = Math.max(t.max, o)
            }

            getMinMax(t, e) {
                const i = this._cachedMeta, s = i._parsed, n = i._sorted && t === i.iScale, o = s.length,
                    a = this._getOtherScale(t), r = ((t, e, i) => t && !e.hidden && e._stacked && {
                        keys: Li(i, !0),
                        values: null
            ...
            _update(t) {
                ...
                this.update(t || "default"), e._clip = function (t) {
                    let e, i, s, n;
                    return B(t) ? (e = t.top, i = t.right, s = t.bottom, n = t.left) : e = i = s = n = t, {
                        top: e,
                        right: i,
                        bottom: s,
                        left: n,
            ...
            _resolveElementOptions(t, e = "default", i) {
                ...
                return f.$shared && (f.$shared = r, n[o] = Object.freeze(Ni(f, r))), f
            }
            ...
            _resolveAnimations(t, e, i) {
                ...
                const l = new Ai(s, r && r.animations);
            ...
            updateElement(t, e, i, s) {
                Wi(s) ? Object.assign(t, i) : this._resolveAnimations(e, s).update(t, i)
            }

            updateSharedOptions(t, e, i) {
                t && !Wi(e) && this._resolveAnimations(void 0, e).update(t, i)
            }
        ...
        function Yi(t, e, i, s) {
            ...
            let h, c, d, u;
            for (h = i, c = i + s; h < c; ++h) u = e[h], d = {}, d[n.axis] = r || n.parse(a[h], h), l.push($i(u, d, o, h));
            return l
        }
        ...
        function Xi(t, e, i, s) {
            ...
            "middle" === n && i && (t.enableBorderRadius = !0, (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[qi(c, a, r, l)] = !0, n = h)), o[qi(n, a, r, l)] = !0, t.borderSkipped = o
        }

        function qi(t, e, i, s) {
            var n, o, a;
            return s ? (a = i, t = Ki(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = Ki(t, e, i), t
        }
        ...
        function Gi(t, {inflateAmount: e}, i) {
                ...
                const c = this._getRingWeight(this.index), {
                        ...
                        if (e < at) {
                            const r = t, l = r + e, h = Math.cos(r), c = Math.sin(r), d = Math.cos(l), u = Math.sin(l),
                                f = (t, e, s) => Pt(t, r, l, !0) ? 1 : Math.max(e, e * i, s, s * i),
                                g = (t, e, s) => Pt(t, r, l, !0) ? -1 : Math.min(e, e * i, s, s * i), p = f(0, h, d),
                                m = f(ct, c, u), b = g(ot, h, d), x = g(ot + ct, c, u);
                            s = (p - b) / 2, n = (m - x) / 2, o = -(p + b) / 2, a = -(m + x) / 2
                        }
                        return {ratioX: s, ratioY: n, offsetX: o, offsetY: a}
                    }(u, d, r), b = (i.width - o) / f, x = (i.height - o) / g, _ = Math.max(Math.min(b, x) / 2, 0),
                    y = j(this.options.radius, _), v = (y - Math.max(y * r, 0)) / this._getVisibleDatasetWeightTotal();
        ...
        var Qi = Object.freeze({
            __proto__: null, BarController: class extends Hi {
                static id = "bar";
                static defaults = {
                    datasetElementType: !1,
                    dataElementType: "bar",
                ...
                parseObjectData(t, e, i, s) {
                    ...
                    let d, u, f, g;
                    for (d = i, u = i + s; d < u; ++d) g = e[d], f = {}, f[n.axis] = n.parse(tt(g, l), d), c.push($i(tt(g, h), f, o, d));
                    return c
                }
                    ...
                    for (let u = e; u < e + i; u++) {
                        const e = this.getParsed(u),
                            ...
                            f = this._calculateBarIndexPixels(u, h), g = (e._stacks || {})[a.axis], p = {
                                horizontal: l,
                                base: i.base,
                                enableBorderRadius: !g || Ui(e._custom) || o === g._top || o === g._bottom,
                                x: l ? i.head : f.center,
                                y: l ? f.center : i.head,
                        ...
                        Xi(p, m, g, o), Gi(p, m, h.ratio), this.updateElement(t[u], u, p, s)
                    }
                }
                ...
                _calculateBarValuePixels(t) {
                    const {_cachedMeta: {vScale: e, _stacked: i, index: s}, options: {base: n, minBarLength: o}} = this,
                        a = n || 0, r = this.getParsed(t), l = r._custom, h = Ui(l);
                    let c, d, u = r[e.axis], f = 0, g = i ? this.applyStack(e, r, i) : u;
                    g !== u && (f = g - u, g = u), h && (u = l.barStart, g = l.barEnd - l.barStart, 0 !== u && gt(u) !== gt(l.barEnd) && (f = 0), f += u);
                    const p = F(n) || h ? f : n;
                ...
                _calculateBarIndexPixels(t, e) {
                    const i = e.scale, s = this.options, n = s.skipNull, o = H(s.maxBarThickness, 1 / 0);
                    let a, r;
                    if (e.grouped) {
                        const i = n ? this._getStackCount(t) : e.stackCount,
                            l = "flex" === s.barThickness ? function (t, e, i, s) {
                                ...
                                let o, a;
                                return F(n) ? (o = e.min * i.categoryPercentage, a = i.barPercentage) : (o = n * s, a = 1), {
                                    chunk: o / s,
                                    ratio: a,
            ...
            }, BubbleController: class extends Hi {
                static id = "bubble";
                static defaults = {
                    datasetElementType: !1,
            ...
            }, DoughnutController: Zi, LineController: class extends Hi {
                static id = "line";
                ...
                update(t) {
                    ...
                    this._drawStart = a, this._drawCount = r, Wt(e) && (a = 0, r = s.length), i._chart = this.chart, i._datasetIndex = this.index, i._decimated = !!n._decimated, i.points = s;
                ...
                updateElements(t, e, i, s) {
                    const n = "reset" === s, {
                            ...
                            _stacked: r,
                            _dataset: l
                        } = this._cachedMeta, {sharedOptions: h, includeOptions: c} = this._getSharedOptions(e, s),
                        d = o.axis, u = a.axis, {spanGaps: f, segment: g} = this.options,
                    ...
                    for (let i = 0; i < x; ++i) {
                        ...
                        const y = this.getParsed(i), v = F(y[u]), M = x[d] = o.getPixelForValue(y[d], i),
            ...
            }, PieController: class extends Zi {
                static id = "pie";
                static defaults = {cutout: 0, rotation: 0, circumference: 360, radius: "100%"}
            }, PolarAreaController: Ji, RadarController: class extends Hi {
                static id = "radar";
                static defaults = {
            ...
            }, ScatterController: class extends Hi {
                static id = "scatter";
                ...
                updateElements(t, e, i, s) {
                    ...
                    for (let h = e; h < e + i; ++h) {
                        const e = t[h], i = this.getParsed(h), g = b ? e : {}, _ = F(i[f]),
        ...
        function ns(t, e, i, s, n) {
            ...
            for (let t = 0, i = o.length; t < i; ++t) {
                const {index: i, data: r} = o[t], {lo: l, hi: h} = ss(o[t], e, a, n);
                for (let t = l; t <= h; ++t) {
                    const e = r[t];
                    e.skip || s(e, i, t)
                }
        ...
        function os(t, e, i, s, n) {
            ...
            return ns(t, i, e, (function (i, a, r) {
        ...
        function as(t, e, i, s, n, o) {
            ...
            return ns(t, i, e, (function (i, h, c) {
        ...
        function rs(t, e, i, s, n, o) {
            return o || t.isPointInArea(e) ? "r" !== i || s ? as(t, e, i, s, n, o) : function (t, e, i, s) {
                let n = [];
                return ns(t, i, e, (function (t, i, o) {
                    const {
                        startAngle: a,
                        endAngle: r
                    } = t.getProps(["startAngle", "endAngle"], s), {angle: l} = Mt(t, {x: e.x, y: e.y});
                    Pt(l, a, r) && n.push({element: t, datasetIndex: i, index: o})
                })), n
            }(t, e, i, n) : []
        }
        ...
        function ls(t, e, i, s, n) {
            ...
            let r = !1;
            return ns(t, i, e, ((t, s, l) => {
                t[a](e[i], n) && (o.push({element: t, datasetIndex: s, index: l}), r = r || t.inRange(e.x, e.y, n))
            })), s && !r ? [] : o
        }

        var hs = {
            evaluateInteractionItems: ns, modes: {
                index(t, e, i, s) {
                    const n = ai(e, t), o = i.axis || "x", a = i.includeInvisible || !1,
                        r = i.intersect ? os(t, n, o, s, a) : rs(t, n, o, !1, s, a), l = [];
                    ...
                    const n = ai(e, t), o = i.axis || "xy", a = i.includeInvisible || !1;
                    ...
                    return os(t, ai(e, t), i.axis || "xy", s, i.includeInvisible || !1)
                }, nearest(t, e, i, s) {
                    const n = ai(e, t), o = i.axis || "xy", a = i.includeInvisible || !1;
                    return rs(t, n, o, i.intersect, s, a)
                }, x(t, e, i, s) {
                    return ls(t, ai(e, t), "x", i.intersect, s)
                }, y(t, e, i, s) {
                    return ls(t, ai(e, t), "y", i.intersect, s)
                }
            }
        };
        ...
        function bs(t, e, i, s) {
            ...
            const r = Math.max(0, e.outerWidth - ps(a, t, "left", "right")),
                l = Math.max(0, e.outerHeight - ps(a, t, "top", "bottom")), h = r !== t.w, c = l !== t.h;
        ...
        function _s(t, e, i, s) {
            ...
            for (o = 0, a = t.length, h = 0; o < a; ++o) {
                r = t[o], l = r.box, l.update(r.width || e.w, r.height || e.h, xs(r.horizontal, e));
                const {same: a, other: d} = bs(e, i, r, s);
                h |= a && n.length, c = c || d, l.fullSize || n.push(r)
            }
            return h && _s(n, e, i, s) || c
        }
        ...
        function vs(t, e, i, s) {
            ...
            for (const r of t) {
                ...
                if (r.horizontal) {
                    ...
                    it(l.start) && (a = l.start), t.fullSize ? ys(t, n.left, a, i.outerWidth - n.right - n.left, o) : ys(t, e.left + l.placed, a, s, o), l.start = a, l.placed += s, a = t.bottom
                } else {
                    const s = e.h * h, a = l.size || t.width;
                    it(l.start) && (o = l.start), t.fullSize ? ys(t, o, n.top, a, i.outerHeight - n.bottom - n.top) : ys(t, o, e.top + l.placed, a, s), l.start = o, l.placed += s, o = t.right
                }
            }
            e.x = o, e.y = a
        }
        ...
        var Ms = {
            addBox(t, e) {
                ...
                if (!t) return;
                const n = Oe(t.options.layout.padding), o = Math.max(e - n.width, 0), a = Math.max(i - n.height, 0),
                    r = function (t) {
                        const e = function (t) {
                                const e = [];
                                let i, s, n, o, a, r;
                                ...
                                return e
                            }(t), i = fs(e.filter((t => t.box.fullSize)), !0), s = fs(ds(e, "left"), !0),
                            n = fs(ds(e, "right")), o = fs(ds(e, "top"), !0), a = fs(ds(e, "bottom")), r = us(e, "x"),
                            l = us(e, "y");
                        return {
                            fullSize: i,
                ...
                ms(u, Oe(s));
                const f = Object.assign({maxPadding: u, w: o, h: a, x: n.left, y: n.top}, n), g = gs(l.concat(h), d);
                _s(r.fullSize, f, d, g), _s(l, f, d, g), _s(h, f, d, g) && _s(l, f, d, g), function (t) {
                ...
                }(f), vs(r.leftAndTop, f, d, g), f.x += f.w, f.y += f.h, vs(r.rightAndBottom, f, d, g), t.chartArea = {
                    left: f.left,
                    top: f.top,
                    right: f.left + f.w,
                    bottom: f.top + f.h,
        ...
        const Os = !!ci && {passive: !0};

        function Cs(t, e, i) {
            t.canvas.removeEventListener(e, i, Os)
        }
        ...
        function Is() {
            ...
            t !== Rs && (Rs = t, Es.forEach(((e, i) => {
                i.currentDevicePixelRatio !== t && e()
            })))
        }

        function zs(t, e, i) {
            const s = t.canvas, n = s && ti(s);
            if (!n) return;
            const o = zt(((t, e) => {
            ...
            return a.observe(n), function (t, e) {
                Es.size || window.addEventListener("resize", Is), Es.set(t, e)
            }(t, o), a
        }

        function Fs(t, e, i) {
            i && i.disconnect(), "resize" === e && function (t) {
                Es.delete(t), Es.size || window.removeEventListener("resize", Is)
            }(t)
        }

        function Vs(t, e, i) {
            const s = t.canvas, n = zt((e => {
                null !== t.ctx && i(function (t, e) {
                    const i = Ps[t.type] || t.type, {x: s, y: n} = ai(t, e);
                    return {type: i, chart: e, native: t, x: void 0 !== s ? s : null, y: void 0 !== n ? n : null}
                }(e, t))
            }), t);
            return function (t, e, i) {
                t.addEventListener(e, i, Os)
            }(s, e, n), n
        }
        ...
        class Bs extends ws {
            ...
            releaseContext(t) {
                ...
                return Object.keys(s).forEach((t => {
                    e.style[t] = s[t]
                })), e.width = e.width, delete e[Ss], !0
            }

            addEventListener(t, e, i) {
                this.removeEventListener(t, e);
                const s = t.$proxies || (t.$proxies = {}), n = {attach: Ts, detach: Ls, resize: zs}[e] || Vs;
                s[e] = n(t, e, i)
            }
            ...
            removeEventListener(t, e) {
                ...
                if (!s) return;
                ({attach: Fs, detach: Fs, resize: Fs}[e] || Cs)(t, e, s), i[e] = void 0
            }
        ...
        function Ns(t, e) {
            ...
            if (a > 0) {
                ...
                for (Hs(e, h, c, F(s) ? 0 : r - s, r), t = 0, i = a - 1; t < i; t++) Hs(e, h, c, o[t], o[t + 1]);
                return Hs(e, h, c, l, F(s) ? e.length : l + s), h
            }
            return Hs(e, h, c), h
        }
        ...
        const js = (t, e, i) => "top" === e || "left" === e ? t[e] + i : t[e] - i, $s = (t, e) => Math.min(e || t, t);
        ...
        function qs(t, e) {
            ...
            const i = Ce(t.font, e), s = Oe(t.padding);
        ...
        class Gs extends Ws {
            ...
            getUserBounds() {
                ...
                return t = N(t, Number.POSITIVE_INFINITY), e = N(e, Number.NEGATIVE_INFINITY), i = N(i, Number.POSITIVE_INFINITY), s = N(s, Number.NEGATIVE_INFINITY), {
                    min: N(t, i),
                    max: N(e, s),
                    minDefined: W(t),
                    maxDefined: W(e)
            ...
            update(t, e, i) {
                ...
                this.beforeUpdate(), this.maxWidth = t, this.maxHeight = e, this._margins = i = Object.assign({
                    ...
                    const {min: s, max: n} = t, o = j(e, (n - s) / 2), a = (t, e) => i && 0 === t ? 0 : t + e;
                    return {min: a(s, -Math.abs(o)), max: a(n, o)}
                }(this, n, s), this._dataLimitsCached = !0), this.beforeBuildTicks(), this.ticks = this.buildTicks() || [], this.afterBuildTicks();
                const r = a < this.ticks.length;
                this._convertTicksToLabels(r ? Ys(this.ticks, a) : this.ticks), this.configure(), this.beforeCalculateLabelRotation(), this.calculateLabelRotation(), this.afterCalculateLabelRotation(), o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = Ns(this, this.ticks), this._labelSizes = null, this.afterAutoSkip()), r && this._convertTicksToLabels(this.ticks), this.beforeFit(), this.fit(), this.afterFit(), this.afterUpdate()
            }
            ...
            calculateLabelRotation() {
                const t = this.options, e = t.ticks, i = $s(this.ticks.length, t.ticks.maxTicksLimit),
                ...
                o = t.offset ? this.maxWidth / i : u / (i - 1), c + 6 > o && (o = u / (i - (t.offset ? .5 : 1)), a = this.maxHeight - Xs(t.grid) - e.padding - qs(t.title, this.chart.options.font), r = Math.sqrt(c * c + d * d), l = yt(Math.min(Math.asin(Dt((h.highest.height + 6) / o, -1, 1)), Math.asin(Dt(a / r, -1, 1)) - Math.asin(Dt(d / r, -1, 1)))), l = Math.max(s, Math.min(n, l))), this.labelRotation = l
            }
                ...
                if (o) {
                    ...
                    if (a ? (t.width = this.maxWidth, t.height = Xs(n) + o) : (t.height = this.maxHeight, t.width = Xs(n) + o), i.display && this.ticks.length) {
                        const {first: e, last: s, widest: n, highest: o} = this._getLabelSizes(), r = 2 * i.padding,
                            l = _t(this.labelRotation), h = Math.cos(l), c = Math.sin(l);
                        if (a) {
            ...
            _convertTicksToLabels(t) {
                let e, i;
                for (this.beforeTickToLabelConversion(), this.generateTickLabels(t), e = 0, i = t.length; e < i; e++) F(t[e].label) && (t.splice(e, 1), i--, e--);
            ...
            _getLabelSizes() {
                ...
                if (!t) {
                    ...
                    let i = this.ticks;
                    e < i.length && (i = Ys(i, e)), this._labelSizes = t = this._computeLabelSizes(i, i.length, this.options.ticks.maxTicksLimit)
                }
                return t
            }

            _computeLabelSizes(t, e, i) {
                const {ctx: s, _longestTextCache: n} = this, o = [], a = [], r = Math.floor(e / $s(e, i));
                let l, h, c, d, u, f, g, p, m, b, x, _ = 0, y = 0;
                for (l = 0; l < e; l += r) {
                    if (d = t[l].label, u = this._resolveTickFontOptions(l), s.font = f = u.string, g = n[f] = n[f] || {
                        data: {},
                        gc: []
                    }, p = u.lineHeight, m = b = 0, F(d) || V(d)) {
                        if (V(d)) for (h = 0, c = d.length; h < c; ++h) x = d[h], F(x) || V(x) || (m = ae(s, g.data, g.gc, m, x), b += p)
            ...
            getPixelForDecimal(t) {
                ...
                return Dt(this._alignToPixels ? le(this.chart, e, 0) : e, -32768, 32767)
            }
            ...
            getContext(t) {
                ...
                return this.$context || (this.$context = Te(this.chart.getContext(), {scale: this, type: "scale"}))
            }

            _tickSize() {
                const t = this.options.ticks, e = _t(this.labelRotation), i = Math.abs(Math.cos(e)),
            ...
            _computeGridLineItems(t) {
                const e = this.axis, i = this.chart, s = this.options, {grid: n, position: o, border: a} = s,
                    r = n.offset, l = this.isHorizontal(), h = this.ticks.length + (r ? 1 : 0), c = Xs(n), d = [],
                ...
                if ("top" === o) m = p(this.bottom), v = this.bottom - c, w = m - g, S = p(t.top) + g, D = t.bottom; else if ("bottom" === o) m = p(this.top), S = t.top, D = p(t.bottom) - g, v = m + g, w = this.top + c; else if ("left" === o) m = p(this.right), y = this.right - c, M = m - g, k = p(t.left) + g, P = t.right; else if ("right" === o) m = p(this.left), k = t.left, P = p(t.right) - g, y = m + g, M = this.left + c; else if ("x" === e) {
                    if ("center" === o) m = p((t.top + t.bottom) / 2 + .5); else if (B(o)) {
                        const t = Object.keys(o)[0], e = o[t];
                        m = p(this.chart.scales[t].getPixelForValue(e))
                    }
                    S = t.top, D = t.bottom, v = m + g, w = v + c
                } else if ("y" === e) {
                    if ("center" === o) m = p((t.left + t.right) / 2); else if (B(o)) {
                        const t = Object.keys(o)[0], e = o[t];
                        m = p(this.chart.scales[t].getPixelForValue(e))
                    }
                    y = m - g, M = y - c, k = t.left, P = t.right
                }
                const O = H(s.ticks.maxTicksLimit, h), C = Math.max(1, Math.ceil(h / O));
                for (b = 0; b < h; b += C) {
                    const t = this.getContext(b), e = n.setContext(t), s = a.setContext(t), o = e.lineWidth,
                        h = e.color, c = s.dash || [], u = s.dashOffset, f = e.tickWidth, g = e.tickColor,
                        p = e.tickBorderDash || [], m = e.tickBorderDashOffset;
                    x = Us(this, b, r), void 0 !== x && (_ = le(i, x, o), l ? y = M = k = P = _ : v = w = S = D = _, d.push({
                        tx1: y,
                        ty1: v,
                        tx2: M,
                        ty2: w,
            ...
            _computeLabelItems(t) {
                const e = this.axis, i = this.options, {position: s, ticks: n} = i, o = this.isHorizontal(),
                    a = this.ticks, {align: r, crossAlign: l, padding: h, mirror: c} = n, d = Xs(i.grid), u = d + h,
                    f = c ? -h : u, g = -_t(this.labelRotation), p = [];
                ...
                if ("top" === s) v = this.bottom - f, M = this._getXAxisLabelAlignment(); else if ("bottom" === s) v = this.top + f, M = this._getXAxisLabelAlignment(); else if ("left" === s) {
                    ...
                    if ("center" === s) v = (t.top + t.bottom) / 2 + u; else if (B(s)) {
                        const t = Object.keys(s)[0], e = s[t];
                        v = this.chart.scales[t].getPixelForValue(e) + u
                    }
                    M = this._getXAxisLabelAlignment()
                } else if ("y" === e) {
                    if ("center" === s) y = (t.left + t.right) / 2 - u; else if (B(s)) {
                        const t = Object.keys(s)[0], e = s[t];
                ...
                for (m = 0, b = a.length; m < b; ++m) {
                    ...
                    w = this.getPixelForTick(m) + n.labelOffset, k = this._resolveTickFontOptions(m), S = k.lineHeight, P = V(_) ? _.length : 1;
                    ...
                    if (o ? (y = w, "inner" === M && (u = m === b - 1 ? this.options.reverse ? "left" : "right" : 0 === m ? this.options.reverse ? "right" : "left" : "center"), D = "top" === s ? "near" === l || 0 !== g ? -P * S + S / 2 : "center" === l ? -C.highest.height / 2 - e * S + S : -C.highest.height + S / 2 : "near" === l || 0 !== g ? S / 2 : "center" === l ? C.highest.height / 2 - e * S : C.highest.height - P * S, c && (D *= -1), 0 === g || t.showLabelBackdrop || (y += S / 2 * Math.sin(g))) : (v = w, D = (1 - P) * S / 2), t.showLabelBackdrop) {
                        const e = Oe(t.backdropPadding), i = C.heights[m], s = C.widths[m];
            ...
            drawBorder() {
                ...
                let l, h, c, d;
                this.isHorizontal() ? (l = le(t, this.left, o) - o / 2, h = le(t, this.right, a) + a / 2, c = d = r) : (c = le(t, this.top, o) - o / 2, d = le(t, this.bottom, a) + a / 2, l = h = r), e.save(), e.lineWidth = n.width, e.strokeStyle = n.color, e.beginPath(), e.moveTo(l, c), e.lineTo(h, d), e.stroke(), e.restore()
            }
            ...
            drawTitle() {
                ...
                if (!i.display) return;
                const n = Ce(i.font), o = Oe(i.padding), a = i.align;
                let r = n.lineHeight / 2;
                "bottom" === e || "center" === e || B(e) ? (r += o.bottom, V(i.text) && (r += n.lineHeight * (i.text.length - 1))) : r += o.top;
                const {titleX: l, titleY: h, maxWidth: c, rotation: d} = function (t, e, i, s) {
                    ...
                    if (t.isHorizontal()) {
                        ...
                        } else f = "center" === i ? (h.bottom + h.top) / 2 + p - e : js(t, i, e);
                        d = r - o
                    } else {
                        if (B(i)) {
                            const t = Object.keys(i)[0], s = i[t];
                            u = c[t].getPixelForValue(s) - m + e
                        } else u = "center" === i ? (h.left + h.right) / 2 - m + e : js(t, i, e);
        ...
        class Zs {
            ...
            register(t) {
                ...
                return n in s || (s[n] = t, function (t, e, i) {
                    ...
                    oe.set(e, s), t.defaultRoutes && function (t, e) {
                ...
                }(t, o, i), this.override && oe.override(t.id, t.overrides)), o
            }
        ...
        class Js {
            constructor() {
                this.controllers = new Zs(Hi, "datasets", !0), this.elements = new Zs(Ws, "elements"), this.plugins = new Zs(Object, "plugins"), this.scales = new Zs(Gs, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
            }
        ...
        class tn {
            ...
            _createDescriptors(t, e) {
                const i = t && t.config, s = H(i.options && i.options.plugins, {}), n = function (t) {
                    const e = {}, i = [], s = Object.keys(Qs.plugins.items);
                    for (let t = 0; t < s.length; t++) i.push(Qs.getPlugin(s[t]));
                    const n = t.plugins || [];
                    for (let t = 0; t < n.length; t++) {
                        const s = n[t];
                ...
                return !1 !== s || e ? function (t, {plugins: e, localIds: i}, s, n) {
                    ...
                    for (const r of e) {
                        const e = r.id, l = en(s[e], n);
                        null !== l && o.push({plugin: r, options: sn(t.config, {plugin: r, local: i[e]}, l, a)})
                    }
                    return o
                }(t, n, s, e) : []
            }
        ...
        function sn(t, {plugin: e, local: i}, s, n) {
        ...
        function an(t, ...e) {
            if (on(t)) return t;
            for (const s of e) {
                const e = s.axis || ("top" === (i = s.position) || "bottom" === i ? "x" : "left" === i || "right" === i ? "y" : void 0) || t.length > 1 && on(t[0].toLowerCase());
                if (e) return e
            }
            var i;
        ...
        function ln(t, e) {
            const i = te[t.type] || {scales: {}}, s = e.scales || {}, n = nn(t.type, e), o = Object.create(null);
            return Object.keys(s).forEach((e => {
                const a = s[e];
                if (!B(a)) return console.error(`Invalid scale configuration for scale: ${e}`);
                if (a._proxy) return console.warn(`Ignoring resolver passed as options for scale: ${e}`);
                const r = an(e, a, function (t, e) {
                    if (e.data && e.data.datasets) {
                        const i = e.data.datasets.filter((e => e.xAxisID === t || e.yAxisID === t));
                        if (i.length) return rn(t, "x", i[0]) || rn(t, "y", i[0])
                    }
                    return {}
                }(e, t), oe.scales[a.type]), l = function (t, e) {
                    return t === e ? "_index_" : "_value_"
                }(r, n), h = i.scales || {};
                o[e] = Z(Object.create(null), [{axis: r}, a, h[r], h[l]])
            })), t.data.datasets.forEach((i => {
                const n = i.type || t.type, a = i.indexAxis || nn(n, e), r = (te[n] || {}).scales || {};
        ...
        function hn(t) {
            ...
            e.plugins = H(e.plugins, {}), e.scales = ln(t, e)
        }
        ...
        const dn = new Map, un = new Set;

        function fn(t, e) {
            let i = dn.get(t);
            return i || (i = e(), dn.set(t, i), un.add(i)), i
        }
        ...
        class pn {
            constructor(t) {
                this._config = function (t) {
                    return (t = t || {}).data = cn(t.data), hn(t), t
            ...
            datasetAnimationScopeKeys(t, e) {
                return fn(`${t}.transition.${e}`, (() => [[`datasets.${t}.transitions.${e}`, `transitions.${e}`], [`datasets.${t}`, ""]]))
            }

            datasetElementScopeKeys(t, e) {
                return fn(`${t}-${e}`, (() => [[`datasets.${t}.elements.${e}`, `datasets.${t}`, `elements.${e}`, ""]]))
            }
            ...
            getOptionScopes(t, e, i) {
                ...
                const r = new Set;
                e.forEach((e => {
                    t && (r.add(t), e.forEach((e => gn(r, t, e)))), e.forEach((t => gn(r, s, t))), e.forEach((t => gn(r, te[n] || {}, t))), e.forEach((t => gn(r, oe, t))), e.forEach((t => gn(r, ee, t)))
                }));
                const l = Array.from(r);
                return 0 === l.length && l.push(Object.create(null)), un.has(e) && o.set(e, l), l
            }
            ...
            resolveNamedOptions(t, e, i, s = [""]) {
                const n = {$shared: !0}, {resolver: o, subPrefixes: a} = mn(this._resolverCache, t, s);
                let r = o;
                if (function (t, e) {
                    const {isScriptable: i, isIndexable: s} = Re(t);
                    for (const n of e) {
                        const e = i(n), o = s(n), a = (o || e) && t[n];
                        if (e && (st(a) || bn(a)) || o && V(a)) return !0
                    }
                    return !1
                }(o, e)) {
                    n.$shared = !1;
                    r = Ee(o, i = st(i) ? i() : i, this.createResolver(t, i, a))
                }
        ...
        function mn(t, e, i) {
            ...
            let o = s.get(n);
            if (!o) {
                o = {resolver: Le(e, i), subPrefixes: i.filter((t => !t.toLowerCase().includes("hover")))}, s.set(n, o)
            }
            return o
        }

        const bn = t => B(t) && Object.getOwnPropertyNames(t).reduce(((e, i) => e || st(t[i])), !1);
        const xn = ["top", "bottom", "left", "right", "chartArea"];
        ...
        function wn(t) {
            return Qe() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]), t && t.canvas && (t = t.canvas), t
        }
        ...
        class Dn {
            ...
            constructor(t, e) {
                const i = this.config = new pn(e), s = wn(t), n = Sn(s);
                ...
                this.platform = new (i.platform || function (t) {
                    return !Qe() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? ks : Bs
                }(s)), this.platform.updateConfig(i);
                const a = this.platform.acquireContext(s, o.aspectRatio), r = a && a.canvas, l = r && r.height,
                    h = r && r.width;
                this.id = z(), this.ctx = a, this.canvas = r, this.width = h, this.height = l, this._options = o, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._responsiveListeners = void 0, this._sortedMetasets = [], this.scales = {}, this._plugins = new tn, this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = function (t, e) {
                    let i;
                    return function (...s) {
                        return e ? (clearTimeout(i), i = setTimeout(t, e, s)) : t.apply(this, s), e
                    }
                }((t => this.update(t)), o.resizeDelay || 0), this._dataChanges = [], kn[this.id] = this, a && r ? (Pi.listen(this, "complete", vn), Pi.listen(this, "progress", Mn), this._initialize(), this.attached && this.update()) : console.error("Failed to create chart: can't acquire context from the given item")
            }
            ...
            resize(t, e) {
                Pi.running(this) ? this._resizeBeforeDraw = {width: t, height: e} : this._resize(t, e)
            }
            ...
            _resize(t, e) {
                ...
                this.width = o.width, this.height = o.height, this._aspectRatio = this.aspectRatio, hi(this, a, !0) && (this.notifyPlugins("resize", {size: o}), $(i.onResize, [this, o], this), this.attached && this._doResize(r) && this.render())
            }
            ...
            buildOrUpdateScales() {
                ...
                e && (n = n.concat(Object.keys(e).map((t => {
                    const i = e[t], s = an(t, i), n = "r" === s, o = "x" === s;
                    return {
                        options: i,
                    ...
                    const n = e.options, o = n.id, a = an(o, n), r = H(n.type, e.dtype);
                    void 0 !== n.position && _n(n.position, a) === _n(e.dposition) || (n.position = e.dposition), s[o] = !0;
                    let l = null;
                    if (o in i && i[o].type === r) l = i[o]; else {
                        l = new (Qs.getScale(r))({id: o, type: r, ctx: this.ctx, chart: this}), i[l.id] = l
                    }
                    l.init(n, t)
                })), Y(s, ((t, e) => {
                    t || delete i[e]
            ...
            buildOrUpdateControllers() {
                ...
                for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
                    ...
                    if (n.type && n.type !== o && (this._destroyDatasetMeta(i), n = this.getDatasetMeta(i)), n.type = o, n.indexAxis = s.indexAxis || nn(o, this.options), n.order = s.order || 0, n.index = i, n.label = "" + s.label, n.visible = this.isDatasetVisible(i), n.controller) n.controller.updateIndex(i), n.controller.linkScales(); else {
                        const e = Qs.getController(o), {datasetElementType: s, dataElementType: a} = oe.datasets[o];
                        Object.assign(e, {
                            dataElementType: Qs.getElement(a),
                            datasetElementType: s && Qs.getElement(s)
            ...
            update(t) {
                ...
                o = this._minPadding = i.layout.autoPadding ? o : 0, this._updateLayout(o), s || Y(n, (t => {
                    t.reset()
                })), this._updateDatasets(t), this.notifyPlugins("afterUpdate", {mode: t}), this._layers.sort(yn("z", "_idx"));
            ...
            render() {
                !1 !== this.notifyPlugins("beforeRender", {cancelable: !0}) && (Pi.has(this) ? this.attached && !Pi.running(this) && Pi.start(this) : (this.draw(), vn({chart: this})))
            }
            ...
            getContext() {
                return this.$context || (this.$context = Te(null, {chart: this, type: "chart"}))
            }
            ...
            _stop() {
                let t, e;
                for (this.stop(), Pi.remove(this), t = 0, e = this.data.datasets.length; t < e; ++t) this._destroyDatasetMeta(t)
            }

            destroy() {
                this.notifyPlugins("beforeDestroy");
                const {canvas: t, ctx: e} = this;
                this._stop(), this.config.clearCache(), t && (this.unbindEvents(), he(t, e), this.platform.releaseContext(e), this.canvas = null, this.ctx = null), delete kn[this.id], this.notifyPlugins("afterDestroy")
            }
        ...
        function On() {
            return Y(Dn.instances, (t => t._plugins.invalidate()))
        }
        ...
        function Tn(t, e, i, s, n, o) {
            ...
            const p = (g - Math.max(.001, g * d - i / ot) / d) / 2, m = l + p + f, b = n - p - f, {
                    outerStart: x,
                    outerEnd: _,
                    innerStart: y,
                    innerEnd: v
                } = Cn(e, u, d, b - m), M = d - x, w = d - _, k = m + x / M, S = b - _ / w, P = u + y, D = u + v,
                O = m + y / P, C = b - v / D;
            if (t.beginPath(), o) {
                const e = (k + S) / 2;
        ...
        function Ln(t, e, i, s, n) {
            ...
            f && function (t, e, i) {
                ...
                let h = n / r;
                t.beginPath(), t.arc(o, a, r, s - h, i + h), l > n ? (h = n / l, t.arc(o, a, l, i + h, s - h, !0)) : t.arc(o, a, n, i + ct, s - ct), t.closePath(), t.clip()
            }(t, e, g), o || (Tn(t, e, i, s, g, n), t.stroke())
        }
        ...
        function zn(t, e, i, s) {
            const {points: n, options: o} = e, {count: a, start: r, loop: l, ilen: h} = In(n, i, s), c = function (t) {
                return t.stepped ? pe : t.tension || "monotone" === t.cubicInterpolationMode ? me : Rn
            }(o);
        ...
        function Fn(t, e, i, s) {
            const n = e.points, {count: o, start: a, ilen: r} = In(n, i, s), {move: l = !0, reverse: h} = s || {};
        ...
        function Wn(t, e, i, s) {
            Bn && !e.options.segment ? function (t, e, i, s) {
                ...
                const {segments: n, options: o} = e, a = Vn(e);
        ...
        class Nn extends Ws {
            ...
            updateControlPoints(t, e) {
                ...
                if ((i.tension || "monotone" === i.cubicInterpolationMode) && !i.stepped && !this._pointsUpdated) {
                    ...
                    Je(this._points, i, t, s, e), this._pointsUpdated = !0
                }
            }
            ...
            get segments() {
                return this._segments || (this._segments = function (t, e) {
                    ...
                    return Mi(t, !0 === s ? [{start: a, end: r, loop: o}] : function (t, e, i, s) {
                        const n = t.length, o = [];
                        let a, r = e, l = t[e];
                        for (a = e + 1; a <= i; ++a) {
                            const i = t[a % n];
            ...
            interpolate(t, e) {
                const i = this.options, s = t[e], n = this.points, o = vi(this, {property: e, start: s, end: s});
                if (!o.length) return;
                const a = [], r = function (t) {
                    return t.stepped ? fi : t.tension || "monotone" === t.cubicInterpolationMode ? gi : ui
                }(i);
                let l, h;
            ...
            path(t, e, i) {
                const s = this.segments, n = Vn(this);
                let o = this._loop;
        ...
        function Yn(t) {
            const e = jn(t), i = e.right - e.left, s = e.bottom - e.top, n = function (t, e, i) {
                const s = t.options.borderWidth, n = t.borderSkipped, o = Pe(s);
                return {
                    t: $n(n.top, o.top, 0, i),
                    r: $n(n.right, o.right, 0, e),
                    b: $n(n.bottom, o.bottom, 0, i),
                    l: $n(n.left, o.left, 0, e)
                }
            }(t, i / 2, s / 2), o = function (t, e, i) {
                const {enableBorderRadius: s} = t.getProps(["enableBorderRadius"]), n = t.options.borderRadius,
                    o = De(n), a = Math.min(e, i), r = t.borderSkipped, l = s || B(n);
                return {
                    topLeft: $n(!l || r.top || r.left, o.topLeft, 0, a),
                    topRight: $n(!l || r.top || r.right, o.topRight, 0, a),
                    bottomLeft: $n(!l || r.bottom || r.left, o.bottomLeft, 0, a),
                    bottomRight: $n(!l || r.bottom || r.right, o.bottomRight, 0, a)
                }
            }(t, i / 2, s / 2);
            return {
        ...
        function Un(t, e, i, s) {
            const n = null === e, o = null === i, a = t && !(n && o) && jn(t, s);
        ...
        var Kn = Object.freeze({
            __proto__: null, ArcElement: class extends Ws {
                static id = "arc";
                static defaults = {
                    borderAlign: "center",
                    borderColor: "#fff",
                ...
                inRange(t, e, i) {
                    const s = this.getProps(["x", "y"], i), {angle: n, distance: o} = Mt(s, {
                            x: t,
                            y: e
                        }), {
                            startAngle: a,
                        ...
                        d = (this.options.spacing + this.options.borderWidth) / 2, u = H(c, r - a) >= at || Pt(n, a, r),
                        f = Ot(o, l + d, h + d);
                    return u && f
                }
                ...
                draw(t) {
                    ...
                    t.fillStyle = e.backgroundColor, t.strokeStyle = e.borderColor, function (t, e, i, s, n) {
                        ...
                        Tn(t, e, i, s, l, n), t.fill()
                    }(t, this, r, n, o), Ln(t, this, r, n, o), t.restore()
                }
            }, BarElement: class extends Ws {
                static id = "bar";
                static defaults = {
                    borderSkipped: "start",
                    borderWidth: 0,
                ...
                draw(t) {
                    const {inflateAmount: e, options: {borderColor: i, backgroundColor: s}} = this, {
                        inner: n,
                        outer: o
                    } = Yn(this), a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? ye : Xn;
                    var r;
            ...
            }, LineElement: Nn, PointElement: class extends Ws {
                static id = "point";
                parsed;
                skip;
                stop;
        ...
        function to(t) {
            ...
            return (i, s) => {
                ...
                n instanceof Zi ? e = function (t, e) {
                    return t.backgroundColor = t.data.map((() => Jn(e++))), e
                }(i, e) : n instanceof Ji ? e = function (t, e) {
                    return t.backgroundColor = t.data.map((() => Qn(e++))), e
                }(i, e) : n && (e = function (t, e) {
                    return t.borderColor = Jn(e), t.backgroundColor = Qn(e), ++e
                }(i, e))
            }
        }
        ...
        var io = {
            id: "colors", defaults: {enabled: !0, forceOverride: !1}, beforeLayout(t, e, i) {
                ...
                if (!i.forceOverride && (eo(s) || (a = n) && (a.borderColor || a.backgroundColor) || o && eo(o))) return;
                var a;
                const r = to(t);
                s.forEach(r)
            }
            ...
            id: "decimation", defaults: {algorithm: "min-max", enabled: !1}, beforeElementsUpdate: (t, e, i) => {
                ...
                t.data.datasets.forEach(((e, n) => {
                    ...
                    let {start: c, count: d} = function (t, e) {
                        ...
                        return l && (n = Dt(At(e, o.axis, a).lo, 0, i - 1)), s = h ? Dt(At(e, o.axis, r).hi + 1, n, i) - n : i - n, {
                            start: n,
                            count: s
                        }
                    }(r, l);
                    ...
                    let u;
                    switch (F(o) && (e._data = l, delete e.data, Object.defineProperty(e, "data", {
                        configurable: !0,
                        enumerable: !0,
                        get: function () {
        ...
        function ho(t, e) {
            ...
            }(t, e), i.length ? new Nn({points: i, options: {tension: 0}, _loop: s, _fullLoop: s}) : null
        }
        ...
        function go(t, e, i) {
            ...
            for (let n = 0; n < i.length; n++) {
                const o = i[n], {first: a, last: r, point: l} = po(o, e, "x");
        ...
        function bo(t) {
            ...
            if ("stack" === i) return function (t) {
                ...
                return new Nn({points: n, options: {}})
            }(t);
            if ("shape" === i) return !0;
            const n = function (t) {
                const e = t.scale || {};
                if (e.getPointPositionForValue) return function (t) {
                    const {scale: e, fill: i} = t, s = e.options, n = e.getLabels().length,
                        o = s.reverse ? e.max : e.min, a = function (t, e, i) {
                            let s;
                            return s = "start" === t ? i : "end" === t ? e.options.reverse ? e.min : e.max : B(t) ? t.value : e.getBaseValue(), s
                        }(i, e, o), r = [];
                    if (s.grid.circular) {
                        const t = e.getPointPositionForValue(0, o);
                        return new mo({x: t.x, y: t.y, radius: e.getDistanceFromCenterForValue(a)})
                    }
                ...
                return function (t) {
                    const {scale: e = {}, fill: i} = t, s = function (t, e) {
                        let i = null;
                        return "start" === t ? i = e.bottom : "end" === t ? i = e.top : B(t) ? i = e.getPixelForValue(t.value) : e.getBasePixel && (i = e.getBasePixel()), i
                    }(i, e);
                    if (W(s)) {
            ...
            return n instanceof mo ? n : ho(n, s)
        }

        function xo(t, e, i) {
            const s = bo(e), {line: n, scale: o, axis: a} = e, r = n.options, l = r.fill,
            ...
            s && n.points.length && (fe(t, i), function (t, e) {
                ...
                t.save(), "x" === l && o !== n && (_o(t, s, a.top), yo(t, {
                    ...
                    scale: r,
                    property: l
                }), t.restore(), t.save(), _o(t, s, a.bottom));
                yo(t, {line: i, target: s, color: o, scale: r, property: l}), t.restore()
            }(t, {line: n, target: s, above: c, below: d, area: i, scale: o, axis: a}), ge(t))
        }
        ...
        function _o(t, e, i) {
            ...
            t.beginPath();
            for (const r of s) {
                const {start: s, end: l} = r, h = n[s], c = n[ro(s, l, n)];
        ...
        function yo(t, e) {
            const {line: i, target: s, property: n, color: o, scale: a} = e, r = function (t, e, i) {
                ...
                for (const t of s) {
                    ...
                    const h = vi(e, l);
                    for (const e of h) {
                        const s = ao(i, o[e.start], o[e.end], e.loop), r = yi(t, n, s);
        ...
        class So extends Ws {
            ...
            fit() {
                ...
                const i = t.labels, s = Ce(i.font), n = s.size, o = this._computeTitleHeight(), {
                    boxWidth: a,
                    itemHeight: r
                } = ko(i, n);
                let l, h;
            ...
            adjustHitBoxes() {
                ...
                } = this, o = pi(n, this.left, this.width);
                if (this.isHorizontal()) {
                    let n = 0, a = Vt(i, this.left + s, this.right - this.lineWidths[n]);
                    for (const r of e) n !== r.row && (n = r.row, a = Vt(i, this.left + s, this.right - this.lineWidths[n])), r.top += this.top + t + s, r.left = o.leftForLtr(o.x(a), r.width), a += r.width + s
                } else {
                    let n = 0, a = Vt(i, this.top + t + s, this.bottom - this.columnSizes[n].height);
                    for (const r of e) r.col !== n && (n = r.col, a = Vt(i, this.top + t + s, this.bottom - this.columnSizes[n].height)), r.top = a, r.left += this.left + s, r.left = o.leftForLtr(o.x(r.left), r.width), a += r.height + s
                }
            }
            ...
            _draw() {
                const {options: t, columnSizes: e, lineWidths: i, ctx: s} = this, {align: n, labels: o} = t,
                    a = oe.color, r = pi(t.rtl, this.left, this.width), l = Ce(o.font), {padding: h} = o, c = l.size,
                    d = c / 2;
                let u;
                this.drawTitle(), s.textAlign = r.textAlign("left"), s.textBaseline = "middle", s.lineWidth = .5, s.font = l.string;
                const {boxWidth: f, boxHeight: g, itemHeight: p} = ko(o, c), m = this.isHorizontal(),
                    b = this._computeTitleHeight();
                u = m ? {x: Vt(n, this.left + h, this.right - i[0]), y: this.top + h + b, line: 0} : {
                    x: this.left + h,
                    y: Vt(n, this.top + b + h, this.bottom - e[0].height),
                    line: 0
                ...
                this.legendItems.forEach(((_, y) => {
                    ...
                    const v = s.measureText(_.text).width, M = r.textAlign(_.textAlign || (_.textAlign = o.textAlign)),
                        w = f + d + v;
                    let k = u.x, S = u.y;
                    r.setWidth(this.width), m ? y > 0 && k + w + h > this.right && (S = u.y += x, u.line++, k = u.x = Vt(n, this.left + h, this.right - i[u.line])) : y > 0 && S + x > this.bottom && (k = u.x = k + e[u.line].width + h, u.line++, S = u.y = Vt(n, this.top + b + h, this.bottom - e[u.line].height));
                    if (function (t, e, i) {
                        ...
                        if (s.fillStyle = H(i.fillStyle, a), s.lineCap = H(i.lineCap, "butt"), s.lineDashOffset = H(i.lineDashOffset, 0), s.lineJoin = H(i.lineJoin, "miter"), s.lineWidth = n, s.strokeStyle = H(i.strokeStyle, a), s.setLineDash(H(i.lineDash, [])), o.usePointStyle) {
                            ...
                            de(s, a, l, e + d, o.pointStyleWidth && f)
                        } else {
                            const o = e + Math.max((c - g) / 2, 0), a = r.leftForLtr(t, f), l = De(i.borderRadius);
                            s.beginPath(), Object.values(l).some((t => 0 !== t)) ? ye(s, {
                                x: a,
                                y: o,
                                w: f,
                                h: g,
                        ...
                        _e(s, i.text, t, e + p / 2, l, {strikethrough: i.hidden, textAlign: r.textAlign(i.textAlign)})
            ...
            drawTitle() {
                const t = this.options, e = t.title, i = Ce(e.font), s = Oe(e.padding);
                if (!e.display) return;
                const n = pi(t.rtl, this.left, this.width), o = this.ctx, a = e.position, r = i.size / 2, l = s.top + r;
                let h, c = this.left, d = this.width;
                if (this.isHorizontal()) d = Math.max(...this.lineWidths), h = this.top + l, c = Vt(t.align, c, this.right - d); else {
                    const e = this.columnSizes.reduce(((t, e) => Math.max(t, e.height)), 0);
                    h = l + Vt(t.align, this.top, this.bottom - e - t.labels.padding - this._computeTitleHeight())
                }
                const u = Vt(a, c, c + d);
                o.textAlign = n.textAlign(Ft(a)), o.textBaseline = "middle", o.strokeStyle = e.color, o.fillStyle = e.color, o.font = i.string, _e(o, e.text, u, h, i)
            }

            _computeTitleHeight() {
                const t = this.options.title, e = Ce(t.font), i = Oe(t.padding);
                return t.display ? e.lineHeight + i.height : 0
            }

            _getLegendItemAt(t, e) {
                let i, s, n;
                if (Ot(t, this.left, this.right) && Ot(e, this.top, this.bottom)) for (n = this.legendHitBoxes, i = 0; i < n.length; ++i) if (s = n[i], Ot(t, s.left, s.left + s.width) && Ot(e, s.top, s.top + s.height)) return this.legendItems[i];
                return null
            }
                ...
                labels: {
                    color: t => t.chart.options.color, boxWidth: 40, padding: 10, generateLabels(t) {
                        ...
                        return t._getSortedDatasetMetas().map((t => {
                            const l = t.controller.getStyle(i ? 0 : void 0), h = Oe(l.borderWidth);
                            return {
        ...
        class Oo extends Ws {
            ...
            update(t, e) {
                ...
                const n = s * Ce(i.font).lineHeight + this._padding.height;
            ...
            _drawArgs(t) {
                ...
                let r, l, h, c = 0;
                return this.isHorizontal() ? (l = Vt(a, i, n), h = e + t, r = n - i) : ("left" === o.position ? (l = i + t, h = Vt(a, s, e), c = -.5 * ot) : (l = n - t, h = Vt(a, e, s), c = .5 * ot), r = s - e), {
                    titleX: l,
                    titleY: h,
                    maxWidth: r,
                    rotation: c
            ...
            draw() {
                ...
                if (!e.display) return;
                const i = Ce(e.font), s = i.lineHeight / 2 + this._padding.top, {
                    titleX: n,
                    titleY: o,
                    maxWidth: a,
                    rotation: r
        ...
        var To = {
            ...
            start(t, e, i) {
                ...
                Ms.configure(t, s, i), Ms.addBox(t, s), Ao.set(t, s)
            },
            stop(t) {
                Ms.removeBox(t, Ao.get(t)), Ao.delete(t)
            },
            beforeUpdate(t, e, i) {
                const s = Ao.get(t);
                Ms.configure(t, s, i), s.options = i
        ...
        function zo(t, e) {
            const i = t.chart.ctx, {body: s, footer: n, title: o} = t, {boxWidth: a, boxHeight: r} = e,
                l = Ce(e.bodyFont), h = Ce(e.titleFont), c = Ce(e.footerFont), d = o.length, u = n.length, f = s.length,
                g = Oe(e.padding);
            ...
            })), x = 0, i.font = c.string, Y(t.footer, _), i.restore(), m += g.width, {width: m, height: p}
        }
        ...
        function Bo(t, e, i, s) {
            const {caretSize: n, caretPadding: o, cornerRadius: a} = t, {xAlign: r, yAlign: l} = i,
                h = n + o, {topLeft: c, topRight: d, bottomLeft: u, bottomRight: f} = De(a);
            let g = function (t, e) {
                let {x: i, width: s} = t;
        ...
        const jo = {
            beforeTitle: I, title(t) {
                ...
                return ""
            }, afterTitle: I, beforeBody: I, beforeLabel: I, label(t) {
            ...
            }, afterLabel: I, afterBody: I, beforeFooter: I, footer: I, afterFooter: I
        };
        ...
        class Yo extends Ws {
            ...
            _resolveAnimations() {
                ...
                const e = this.chart, i = this.options.setContext(this.getContext()),
                    s = i.enabled && e.options.animation && i.animations, n = new Ai(this.chart, s);
            ...
            getTitle(t, e) {
                const {callbacks: i} = e, s = $o(i, "beforeTitle", this, t), n = $o(i, "title", this, t),
                    o = $o(i, "afterTitle", this, t);
                let a = [];
                return a = Eo(a, Ro(s)), a = Eo(a, Ro(n)), a = Eo(a, Ro(o)), a
            }

            getBeforeBody(t, e) {
                return No($o(e.callbacks, "beforeBody", this, t))
            }

            getBody(t, e) {
                const {callbacks: i} = e, s = [];
                return Y(t, (t => {
                    const e = {before: [], lines: [], after: []}, n = Ho(i, t);
                    Eo(e.before, Ro($o(n, "beforeLabel", this, t))), Eo(e.lines, $o(n, "label", this, t)), Eo(e.after, Ro($o(n, "afterLabel", this, t))), s.push(e)
                })), s
            }

            getAfterBody(t, e) {
                return No($o(e.callbacks, "afterBody", this, t))
            }

            getFooter(t, e) {
                const {callbacks: i} = e, s = $o(i, "beforeFooter", this, t), n = $o(i, "footer", this, t),
                    o = $o(i, "afterFooter", this, t);
                let a = [];
                return a = Eo(a, Ro(s)), a = Eo(a, Ro(n)), a = Eo(a, Ro(o)), a
            }
            ...
            _createItems(t) {
                ...
                let a, r, l = [];
                for (a = 0, r = e.length; a < r; ++a) l.push(Io(this.chart, e[a]));
                return t.filter && (l = l.filter(((e, s, n) => t.filter(e, s, n, i)))), t.itemSort && (l = l.sort(((e, s) => t.itemSort(e, s, i)))), Y(l, (e => {
                    const i = Ho(t.callbacks, e);
                    s.push($o(i, "labelColor", this, e)), n.push($o(i, "labelPointStyle", this, e)), o.push($o(i, "labelTextColor", this, e))
            ...
            update(t, e) {
                ...
                if (s.length) {
                    ...
                    const e = this._size = zo(this, i), a = Object.assign({}, t, e), r = Vo(this.chart, i, a),
            ...
            getCaretPosition(t, e, i) {
                const {xAlign: s, yAlign: n} = this, {caretSize: o, cornerRadius: a} = i, {
                    ...
                    bottomLeft: h,
                    bottomRight: c
                } = De(a), {x: d, y: u} = t, {width: f, height: g} = e;
                let p, m, b, x, _, y;
            ...
            drawTitle(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = Wo(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = Ce(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r) e.fillText(s[r], l.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + a, r + 1 === n && (t.y += i.titleMarginBottom - a)
                }
            }

            _drawColorBox(t, e, i, s, n) {
                const o = this.labelColors[i], a = this.labelPointStyles[i], {boxHeight: r, boxWidth: l} = n,
                    h = Ce(n.bodyFont), c = Wo(this, "left", n), d = s.x(c),
                ...
                if (n.usePointStyle) {
                    ...
                    t.strokeStyle = n.multiKeyBackground, t.fillStyle = n.multiKeyBackground, ce(t, e, i, h), t.strokeStyle = o.borderColor, t.fillStyle = o.backgroundColor, ce(t, e, i, h)
                } else {
                    t.lineWidth = B(o.borderWidth) ? Math.max(...Object.values(o.borderWidth)) : o.borderWidth || 1, t.strokeStyle = o.borderColor, t.setLineDash(o.borderDash || []), t.lineDashOffset = o.borderDashOffset || 0;
                    const e = s.leftForLtr(d, l), i = s.leftForLtr(s.xPlus(d, 1), l - 2), a = De(o.borderRadius);
                    Object.values(a).some((t => 0 !== t)) ? (t.beginPath(), t.fillStyle = n.multiKeyBackground, ye(t, {
                        x: e,
                        y: f,
                        w: l,
                        h: r,
            ...
            drawBody(t, e, i) {
                ...
                const f = pi(i.rtl, this.x, this.width), g = function (i) {
                    e.fillText(i, f.x(t.x + u), t.y + d / 2), t.y += d + n
                }, p = f.textAlign(o);
                let m, b, x, _, y, v, M;
                for (e.textAlign = o, e.textBaseline = "middle", e.font = c.string, t.x = Wo(this, p, i), e.fillStyle = i.bodyColor, Y(this.beforeBody, g), u = a && "right" !== p ? "center" === o ? l / 2 + h : l + 2 + h : 0, _ = 0, v = s.length; _ < v; ++_) {
                    for (m = s[_], b = this.labelTextColors[_], e.fillStyle = b, Y(m.before, g), x = m.lines, a && x.length && (this._drawColorBox(e, t, _, f, i), d = Math.max(c.lineHeight, r)), y = 0, M = x.length; y < M; ++y) g(x[y]), d = c.lineHeight;
                    Y(m.after, g)
                }
            ...
            drawFooter(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = Wo(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = Ce(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a) e.fillText(s[a], r.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + i.footerSpacing
                }
            }
            ...
            _updateAnimationTarget(t) {
                ...
                if (s || n) {
                    ...
                    if (!i) return;
                    const o = this._size = zo(this, t), a = Object.assign({}, i, this._size), r = Vo(e, t, a),
                        l = Bo(t, a, r, e);
            ...
            draw(t) {
                ...
                e.enabled && a && (t.save(), t.globalAlpha = i, this.drawBackground(n, t, s, e), mi(t, e.textDirection), n.y += o.top, this.drawTitle(n, t, e), this.drawBody(n, t, e), this.drawFooter(n, t, e), bi(t, e.textDirection), t.restore())
            }
            ...
            _positionChanged(t, e) {
                const {caretX: i, caretY: s, options: n} = this, o = Lo[n.position].call(this, t, e);
        ...
        function Go(t, e) {
            const i = [], {
                ...
                maxDigits: c,
                includeBounds: d
            } = t, u = n || 1, f = h - 1, {min: g, max: p} = e, m = !F(o), b = !F(a), x = !F(l), _ = (p - g) / (c + 1);
            let y, v, M, w, k = mt((p - g) / f / u) * u;
            if (k < 1e-14 && !m && !b) return [{value: g}, {value: p}];
            w = Math.ceil(p / k) - Math.floor(g / k), w > f && (k = mt(w * k / f / u) * u), F(r) || (y = Math.pow(10, r), k = Math.ceil(k * y) / y), "ticks" === s ? (v = Math.floor(g / k) * k, M = Math.ceil(p / k) * k) : (v = g, M = p), m && b && n && function (t, e) {
                const i = Math.round(t);
                return i - e <= t && i + e >= t
            }((a - o) / n, k / 1e3) ? (w = Math.round(Math.min((a - o) / k, h)), k = (a - o) / w, v = o, M = a) : x ? (v = m ? o : v, M = b ? a : M, w = l - 1, k = (M - v) / w) : (w = (M - v) / k, w = pt(w, Math.round(w), k / 1e3) ? Math.round(w) : Math.ceil(w));
            const S = Math.max(vt(k), vt(v));
            y = Math.pow(10, F(r) ? S : r), v = Math.round(v * y) / y, M = Math.round(M * y) / y;
            let P = 0;
            for (m && (d && v !== o ? (i.push({value: o}), v < o && P++, pt(Math.round((v + P * k) * y) / y, o, Zo(o, _, t)) && P++) : v < o && P++); P < w; ++P) {
                const t = Math.round((v + P * k) * y) / y;
                if (b && t > a) break;
                i.push({value: t})
            }
            return b && d && M !== a ? i.length && pt(i[i.length - 1].value, a, Zo(a, _, t)) ? i[i.length - 1].value = a : i.push({value: a}) : b && M !== a || i.push({value: M}), i
        }

        function Zo(t, e, {horizontal: i, minRotation: s}) {
            const n = _t(s), o = (i ? Math.sin(n) : Math.cos(n)) || .001, a = .75 * e * ("" + t).length;
        ...
        class Jo extends Gs {
            ...
            buildTicks() {
                ...
                return "ticks" === t.bounds && xt(s, this, "value"), t.reverse ? (s.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), s
            }
        ...
        class Qo extends Jo {
            ...
            computeTickLimit() {
                const t = this.isHorizontal(), e = t ? this.width : this.height, i = _t(this.options.ticks.minRotation),
        ...
        const ta = t => Math.floor(ft(t)), ea = (t, e) => Math.pow(10, ta(t) + e);
        ...
        function na(t, {min: e, max: i}) {
            ...
            const f = N(t.max, u);
            return s.push({value: f, major: ia(f), significand: d}), s
        }
        ...
        class oa extends Gs {
            ...
            determineDataLimits() {
                const {min: t, max: e} = this.getMinMax(!0);
                this.min = W(t) ? Math.max(0, t) : null, this.max = W(e) ? Math.max(0, e) : null, this.options.beginAtZero && (this._zero = !0), this._zero && this.min !== this._suggestedMin && !W(this._userMin) && (this.min = t === ea(this.min, 0) ? ea(this.min, -1) : ea(this.min, 0)), this.handleTickRangeOptions()
            }
            ...
            handleTickRangeOptions() {
                ...
                i === s && (i <= 0 ? (n(1), o(10)) : (n(ea(i, -1)), o(ea(s, 1)))), i <= 0 && n(ea(s, -1)), s <= 0 && o(ea(i, 1)), this.min = i, this.max = s
            }

            buildTicks() {
                const t = this.options, e = na({min: this._userMin, max: this._userMax}, this);
                return "ticks" === t.bounds && xt(e, this, "value"), t.reverse ? (e.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), e
            }
        ...
        function la(t) {
            ...
            for (let d = 0; d < o; d++) {
                ...
                n[d] = o.padding;
                const u = t.getPointPosition(d, t.drawingArea + n[d], r), f = Ce(o.font),
                    g = (l = t.ctx, h = f, c = V(c = t._pointLabels[d]) ? c : [c], {
                        w: re(l, h.string, c),
                        h: c.length * h.lineHeight
                    });
                s[d] = g;
                const p = St(t.getIndexAngle(d) + r), m = Math.round(yt(p));
                ha(i, e, p, ra(m, u.x, g.w, 0, 180), ra(m, u.y, g.h, 90, 270))
            }
            var l, h, c;
            t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b), t._pointLabelItems = function (t, e, i) {
                const s = [], n = t._pointLabels.length, o = t.options, {
                    centerPointLabels: a,
                    display: r
                } = o.pointLabels, l = {extra: aa(o) / 2, additionalAngle: a ? ot / n : 0};
                let h;
                for (let o = 0; o < n; o++) {
                    l.padding = i[o], l.size = e[o];
                    const n = ca(t, o, l);
                    s.push(n), "auto" === r && (n.visible = da(n, h), n.visible && (h = n))
                }
                return s
            }(t, s, n)
        }
        ...
        function ca(t, e, i) {
            const s = t.drawingArea, {extra: n, additionalAngle: o, padding: a, size: r} = i,
                l = t.getPointPosition(e, s + n + a, o), h = Math.round(yt(St(l.angle + ct))), c = function (t, e, i) {
        ...
        function ua(t, e, i) {
            ...
            if (!F(r)) {
                const i = De(e.borderRadius), l = Oe(e.backdropPadding);
                t.fillStyle = r;
                const h = s - l.left, c = n - l.top, d = o - s + l.width, u = a - n + l.height;
                Object.values(i).some((t => 0 !== t)) ? (t.beginPath(), ye(t, {
                    x: h,
                    y: c,
                    w: d,
                    h: u,
        ...
        class ga extends Jo {
            ...
            setDimensions() {
                const t = this._padding = Oe(aa(this.options) / 2), e = this.width = this.maxWidth - t.width,
            ...
            generateTickLabels(t) {
                Jo.prototype.generateTickLabels.call(this, t), this._pointLabels = this.getLabels().map(((t, e) => {
            ...
            drawGrid() {
                const t = this.ctx, e = this.options, {angleLines: i, grid: s, border: n} = e,
                ...
                if (e.pointLabels.display && function (t, e) {
                    ...
                    for (let n = e - 1; n >= 0; n--) {
                        ...
                        ua(i, o, e);
                        const a = Ce(o.font), {x: r, y: l, textAlign: h} = e;
                        _e(i, t._pointLabels[n], r, l + a.lineHeight / 2, a, {
                            color: o.color,
                            textAlign: h,
                            textBaseline: "middle"
                        })
                    ...
                    if (0 !== e) {
                        ...
                        !function (t, e, i, s, n) {
                            ...
                            !a && !s || !r || !l || i < 0 || (o.save(), o.strokeStyle = r, o.lineWidth = l, o.setLineDash(n.dash), o.lineDashOffset = n.dashOffset, o.beginPath(), fa(t, i, a, s), o.closePath(), o.stroke(), o.restore())
                        }(this, a, r, o, l)
                    }
                })), i.display) {
        ...
        function xa(t, e) {
            ...
            let a = e;
            return "function" == typeof s && (a = s(a)), W(a) || (a = "string" == typeof s ? i.parse(a, s) : i.parse(a)), null === a ? null : (n && (a = "week" !== n || !bt(o) && !0 !== o ? i.startOf(a, n) : i.startOf(a, "isoWeek", o)), +a)
        }
        ...
        class Ma extends Gs {
            ...
            init(t, e = {}) {
                const i = t.time || (t.time = {}), s = this._adapter = new is(t.adapters.date);
            ...
            determineDataLimits() {
                ...
                o && a || (r(this._getLabelBounds()), "ticks" === t.bounds && "labels" === t.ticks.source || r(this.getMinMax(!1))), s = W(s) && !isNaN(s) ? s : +e.startOf(Date.now(), i), n = W(n) && !isNaN(n) ? n : +e.endOf(Date.now(), i) + 1, this.min = Math.min(s, n - 1), this.max = Math.max(s + 1, n)
            }
            ...
            _generate() {
                const t = this._adapter, e = this.min, i = this.max, s = this.options, n = s.time,
                    o = n.unit || _a(n.minUnit, e, i, this._getLabelCapacity(e)), a = H(s.ticks.stepSize, 1),
                    r = "week" === o && n.isoWeekday, l = bt(r) || !0 === r, h = {};
                let c, d, u = e;
                ...
                for (c = u, d = 0; c < i; c = +t.add(c, a, o), d++) ya(h, c, f);
                return c !== i && "ticks" !== s.bounds && 1 !== d || ya(h, c, f), Object.keys(h).sort(ba).map((t => +t))
            }
            ...
            _getLabelSize(t) {
                const e = this.options.ticks, i = this.ctx.measureText(t).width,
                    s = _t(this.isHorizontal() ? e.maxRotation : e.minRotation), n = Math.cos(s), o = Math.sin(s),
        ...
        function wa(t, e, i) {
            ...
            i ? (e >= t[r].pos && e <= t[l].pos && ({lo: r, hi: l} = At(t, "pos", e)), ({
                pos: s,
                time: o
            } = t[r]), ({pos: n, time: a} = t[l])) : (e >= t[r].time && e <= t[l].time && ({
                lo: r,
                hi: l
            } = At(t, "time", e)), ({time: s, pos: o} = t[r]), ({time: n, pos: a} = t[l]));
            const h = n - s;
        ...
        var ka = Object.freeze({
            __proto__: null,
            CategoryScale: class extends Gs {
                static id = "category";
                static defaults = {ticks: {callback: Ko}};
                ...
                parse(t, e) {
                    ...
                    return ((t, e) => null === t ? null : Dt(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : qo(i, t, H(e, t), this._addedLabels), i.length - 1)
                }
            ...
            TimeScale: Ma,
            TimeSeriesScale: class extends Ma {
                static id = "timeseries";
                static defaults = Ma.defaults;
                ...
                initOffsets() {
                    ...
                    this._minPos = wa(e, this.min), this._tableRange = wa(e, this.max) - this._minPos, super.initOffsets(t)
                }

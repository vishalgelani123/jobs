...
class PreVendorFollowupDetailDataTable extends DataTable
{
    ...
    public function query(PreVendorFollowupDetail $model)
    {
        return $model->newQuery()->where('pre_vendor_detail_id', $this->request()->pre_vendor_detail->id)->latest();
    }

    public function html()
    {
        return $this->builder()
            ->setTableId('pre-vendor-followup-details-table')
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('next_followup_date')->title('Next Followup Date'),
    ...
    {
        return 'preVendorFollowupDetails_' . date('YmdHis');
    }
}

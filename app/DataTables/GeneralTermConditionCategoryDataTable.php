...
class GeneralTermConditionCategoryDataTable extends DataTable
{
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('term_conditions', function ($query) {
                return '<a class="action-button" href="' . route('general-term-condition-categories.details', $query) . '">' . $query->termConditions->count() . '</a>';
            })
            ->rawColumns(['term_conditions', 'action']);
    }

    public function query(GeneralTermConditionCategory $model)
    {
    ...
    {
        return 'GeneralTermConditionsCategories_' . date('YmdHis');
    }
}

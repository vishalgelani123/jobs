...
class GeneralChargeDataTable extends DataTable
{
        ...
        return datatables()
            ...
            ->addColumn('status', function ($query) {
                if ($query->status == 'active') {
                    return '<button class="btn btn-custom-primary btn-sm" onclick="changeStatus(`' . route('general-charges.status.change', $query) . '`)">Active</button>';
                }
                return '<button class="btn btn-danger btn-sm" onclick="changeStatus(`' . route('general-charges.status.change', $query) . '`)">Inactive</button>';
            })
    ...
    public function query(GeneralCharge $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('general-charges-table')
    ...
    {
        return 'generalCharges_' . date('YmdHis');
    }
}

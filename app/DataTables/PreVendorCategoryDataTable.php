...
class PreVendorCategoryDataTable extends DataTable
{
    ...
    public function query(PreVendorCategory $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('pre-vendor-categories-table')
    ...
    {
        return 'preVendorCategories_' . date('YmdHis');
    }
}

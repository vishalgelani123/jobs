...
class SmtpSettingDataTable extends DataTable
{
    ...
    public function query(SmtpSetting $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('smtp-settings-table')
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('mail_host')->title('Mail Host'),
            Column::make('mail_port')->title('Mail Port'),
            Column::make('mail_username')->title('Mail Username'),
            Column::make('mail_from_name')->title('Mail Form Name'),
            Column::make('mail_encryption')->title('Mail Encryption'),
    ...
    {
        return 'SmtpSettings_' . date('YmdHis');
    }
}

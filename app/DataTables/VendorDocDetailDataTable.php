...
class VendorDocDetailDataTable extends DataTable
{
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('vendor_doc_type', function ($query) {
                return isset($query->vendorDocType->name) ? $query->vendorDocType->name : '';
            })
    ...
    public function query(VendorDocDetail $model)
    {
        return $model->newQuery()->with('vendorType', 'vendorDocType')->latest();
    }

    public function html()
    {
        return $this->builder()
            ->setTableId('vendor-doc-details-table')
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('vendor_doc_type')->title('Vendor Doc Type')->name('vendorDocType.name'),
    ...
    {
        return 'vendorDocDetails_' . date('YmdHis');
    }
}

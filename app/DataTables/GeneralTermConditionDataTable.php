...
class GeneralTermConditionDataTable extends DataTable
{
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('description', function ($query) {
                return '<a class="btn btn-primary btn-sm" href="' . route('general-term-conditions.category.description', [$query->category,$query]) . '">View</a>';
            })
    ...
    public function query(GeneralTermCondition $model)
    {
        return $model->newQuery()->where('category_id', $this->request()->general_term_condition_category->id)->latest();
    }

    public function html()
    {
        return $this->builder()
            ->setTableId('general-term-conditions-table')
    ...
    {
        return 'GeneralTermConditions_' . date('YmdHis');
    }
}

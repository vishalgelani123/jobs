                ...
                <div class="bs-stepper-content">
                    <div class="row text-nowrap">
                        ...
                        <div class="col-md-12 d-flex justify-content-between">
                            <a href="{{route('vendor-branches.branch.detail',$branch)}}" class="btn btn-submit btn-prev waves-effect">
                                <i class="ti ti-arrow-left me-sm-1 me-0"></i>
                                <span class="align-middle d-sm-inline-block d-none">Previous</span>
                            </a>
                            <a href="{{route('vendor-branches.bank.detail',$branch)}}" class="btn btn-submit btn-next waves-effect waves-light">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('vendor-branches.registration.detail.store',$branch)}}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2 gst-fields d-none">
                            ...
                            <div class="col-md-6 mb-2 attachment-fields d-none">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control" value="{{$branch->pf_no}}" name="pf_no"
                                       id="pf_no"
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select id="digital_signature" name="digital_signature"
                                    ...
                                    <option @if($branch->digital_signature == 'no') selected @endif value="no">No
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-6 mb-2">
                            ...
                            <div class="col-md-6 mb-2 msme-fields d-none">
